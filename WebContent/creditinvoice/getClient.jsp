...
/* 	String dtype=session.getAttribute("Code").toString();
  String clientid=request.getParameter("clientid").trim().toString();
	...
	String strSq = "select cldocno doc_no,refname client,tax from my_acbook where dtype='CRM'";
	...
	System.out.println(cldocno+"####"+client+"####"+tax);
	response.getWriter().write(cldocno+"####"+client+"####"+tax);
