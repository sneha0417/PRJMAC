...
<%
	...
	try{
		...
		java.sql.Date sqlcontractfromdate=null,sqlcontracttodate=null;
	 	val=DAO.insert(date,"0","1","1","1",0,cid,"0","DIR","0","web app credit invoice", netotal,"0", netaxtotal,"0","0", netaxtotal,"A","INV", prodarray, termsarray, servarray, session, request,"0","0",date,1,"credit","0", shiparray,0,ttotal,ttotal,0.0,0.0,ttotal,1,"0","0","0");
