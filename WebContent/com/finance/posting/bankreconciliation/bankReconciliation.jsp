...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxBankReconciliationDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
		 $("#maindate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
		 $('#txtforsearch').val(2);

         /* Force internal alignment AFTER render */
         setTimeout(function () {
             $("#jqxBankReconciliationDate, #maindate").find("input").css({
                 "margin-top": "0px",
                 "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
             ...
             $("#jqxBankReconciliationDate, #maindate").find(".jqx-action-button").css({
                 "top": "0px",
                 "height": "24px"
             });
         }, 0);
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <select id="cmbbranch" name="cmbbranch" style="width:120px;" value='<s:property value="cmbbranch"/>'>
                <option></option>
            </select>
            ...
            <select id="cmbcurrency" name="cmbcurrency" style="width:100px;" value='<s:property value="cmbcurrency"/>' onload="getRatevalue(this.value);">
                <option></option>
            </select>
            ...
            <i style="margin-left: 5px;"><b><label id="lblformposted" name="lblformposted" style="font-size: 1px; font-family: Tahoma; color:#E0ECF8;"><s:property value="lblformposted"/></label></b></i>
            
            <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
            <input type="text" id="docno" name="txtbankreconciliationdocno" style="width:100px;" value='<s:property value="txtbankreconciliationdocno"/>' tabindex="-1" readonly/>
        </div>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Account</label>
            <input type="text" id="txtaccid" name="txtaccid" style="width:120px;" placeholder="Press F3 to Search" value='<s:property value="txtaccid"/>' onkeydown="getAcc(event);"/>
            <input type="text" id="txtaccname" name="txtaccname" style="width:200px;" value='<s:property value="txtaccname"/>' tabindex="-1" readonly/>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Reconciliation Entries</span>
        <div id="jqxBankReconciliationGrid" class="grid-container">
            <jsp:include page="bankReconciliationGrid.jsp"></jsp:include>
        </div>
        
        <div class="field-row" style="margin-top: 15px; justify-content: space-between; flex-wrap: wrap; margin-bottom:0;">
            <div style="display:flex; align-items:center;">
                <label class="lbl-right" style="width:90px;">Book Balance</label>
                <input type="text" id="txtbookbalance" name="txtbookbalance" style="width:120px; text-align:right;" value='<s:property value="txtbookbalance"/>' tabindex="-1" readonly/>
            </div>
            
            <div style="display:flex; align-items:center;">
                <label class="lbl-right" style="width:150px;">Uncleared Payments (+ve)</label>
                <input type="text" id="txtunclrpayments" name="txtunclrpayments" style="width:120px; text-align:right;" value='<s:property value="txtunclrpayments"/>' tabindex="-1" readonly/>
            </div>
            
            <div style="display:flex; align-items:center;">
                <label class="lbl-right" style="width:150px;">Uncleared Receipts (-ve)</label>
                <input type="text" id="txtunclrreceipts" name="txtunclrreceipts" style="width:120px; text-align:right;" value='<s:property value="txtunclrreceipts"/>' tabindex="-1" readonly/>
            </div>
            
            <div style="display:flex; align-items:center;">
                <label class="lbl-right" style="width:110px;">Bank St. Balance</label>
                <input type="text" id="txtbankbalance" name="txtbankbalance" style="width:120px; text-align:right;" value='<s:property value="txtbankbalance"/>' tabindex="-1" readonly/>
            </div>
        </div>
    </div>
