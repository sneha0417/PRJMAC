...
<script type="text/javascript">
	$(document).ready(function() {      
		 ...
		 $("#jqxDate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value: null, theme: 'energyblue' });
		 ...
		 $("#chequedate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
		 $("#checkchequedate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
    ...
    /* ===============================================
       ...
       =============================================== */
    function openAccSearch() {
        var atype = $('#cmbacctype').val();
        accountSearchContent("<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype=" + atype);
    }
    /* =============================================== */
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            <label class="lbl-right" style="width:60px;">Criteria</label>
            <select id="cmbcriteria" name="cmbcriteria" style="width:240px;" value='<s:property value="cmbcriteria"/>' onchange="dateDisable();getPDCAccounts();clearClientInfo();">
            ...
            <label class="lbl-right" style="width:60px; margin-left:15px;">From</label>
            ...
            <label class="lbl-right" style="width:60px; margin-left:15px;">To</label>
            <div style="width: 125px;">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <select id="cmbacctype" name="cmbacctype" style="width:90px;" onchange="clearClientInfo();" value='<s:property value="cmbacctype"/>'>
            ...
            <div class="input-search-container" style="width: 140px; margin-left:10px;">
                <input type="text" id="txtaccid" name="txtaccid" placeholder="Press F3" value='<s:property value="txtaccid"/>' onkeydown="getAcc(event);"/>
                <svg class="magnifier-icon" onclick="openAccSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            
            <input type="text" id="txtaccname" name="txtaccname" style="flex:1; margin-left:10px;" value='<s:property value="txtaccname"/>'/>
            <input type="hidden" id="txtdocno" name="txtdocno" value='<s:property value="txtdocno"/>'/>
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Posting</label>
            <div style="width: 125px;">
            ...
            <button class="myButton" type="button" id="btnview" name="btnview" onclick="funloadgrid();" style="margin-left: 15px;">View</button>
        </div>
    </div>

    <!-- Journal Voucher Grid -->
    <div class="middle-panel">
        <span class="middle-panel-title">Journal Vouchers</span>
        <div id="jqxJournalVoucherGrid" class="grid-container">
            <jsp:include page="journalVoucherGrid.jsp"></jsp:include>
        </div>
    </div>

    <!-- Applying Grid (Shows based on criteria) -->
    <div id="jqxJournalVoucherApplyingGrid">
        <div class="middle-panel">
            <span class="middle-panel-title">Apply Voucher</span>
    ...
    <!-- PDC Postponed Details (Shows when criteria == 4) -->
    <div id="pdcPostponedDiv" style="display:none;">
        <div class="middle-panel" style="background: #f4faeb; border-color:#d4e5c3;">
            <span class="middle-panel-title" style="background: #f4faeb; color:#2c5e00; border-left-color:#539a13;">PDC Postponement Details</span>
            
            <div class="field-row">
                <label class="lbl-right" style="width:80px;">Bank</label>
                <input type="text" id="txtbankaccid" name="txtbankaccid" style="width:120px;" value='<s:property value="txtbankaccid"/>'/>
                <input type="text" id="txtbankaccname" name="txtbankaccname" style="flex:1;" value='<s:property value="txtbankaccname"/>'/>
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div style="width: 125px;">
                    ...
                    <div style="display:none;" id="checkchequedate" name="checkchequedate" value='<s:property value="checkchequedate"/>'></div>
                </div>
            </div>
        </div>
    </div>
