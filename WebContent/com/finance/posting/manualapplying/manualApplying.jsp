...
<script type="text/javascript">
    ...
    function funNotify(){	
        ...
        if(parseFloat(document.getElementById("txtapplyinvoiceamt").value)<parseFloat(appliedamount)){
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Account Selection</span>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="txtaccname" name="txtaccname" style="flex:1;" readonly value='<s:property value="txtaccname"/>'/>
            <input type="hidden" id="txtdocno" name="txtdocno" value='<s:property value="txtdocno"/>'/>
            
            <button class="myButton" type="button" id="btnSubmit" name="btnSubmit" style="margin-left:15px;" onclick="funloadappliedgrid();">Submit</button>
        </div>
    </div>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Application Summary</span>
        ...
        <div class="field-row" style="margin-bottom:0; justify-content: flex-end;">
            ...
            <label class="lbl-right" style="width:60px; margin-left:10px;">Doc Type</label>
            <input type="text" id="txtdoctype" name="txtdoctype" style="width:60px;" readonly value='<s:property value="txtdoctype"/>' tabindex="-1"/>

            <label class="lbl-right" style="width:60px; margin-left:10px;">Amount</label>
            ...
            <label class="lbl-right" style="width:60px; margin-left:10px;">Applying</label>
            ...
            <label class="lbl-right" style="width:60px; margin-left:10px;">Balance</label>
            ...
            <button class="myButton" type="button" id="btnUpdate" name="btnUpdate" style="margin-left: 15px;" onkeydown="funUpdateChanges();" onclick="funUpdateChanges();">Update</button>
        </div>
    </div>
