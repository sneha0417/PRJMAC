...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#jqxUnclearedChequeProcessingDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
        $("#jqxUnclearedChequeProcessFromDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
        $("#jqxUnclearedChequeProcessToDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
        $("#postingDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", value: null });
    ...
    <form id="frmUnclearedChequeProcessing" action="saveUnclearedChequeProcessing" method="post" autocomplete="off">
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Processing Parameters</span>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px;">P.D.C From</label>
                    ...
                    <label class="lbl-right" style="width:70px; margin-left:10px;">P.D.C. Upto</label>
                    <div style="width: 125px;">
                    ...
                    <label class="lbl-right" style="width:40px; margin-left:10px;">Type</label>
                    <select id="cmbtype" name="cmbtype" style="width:110px;" value='<s:property value="cmbtype"/>'>
                        <option value="">--Select--</option>
                        <option value="UCP">Payment</option>
                        <option value="UCR">Receipt</option>
                    </select>

                    <label class="lbl-right" style="width:50px; margin-left:10px;">Posting</label>
                    <div style="width: 125px;">
                        <div id="postingDate" name="postingDate" onchange="datechange();" onblur="datechange();" value='<s:property value="postingDate"/>'></div>
                    </div>

                    <button class="myButton" type="button" id="btnUnclearedChequeSearch" name="btnUnclearedChequeSearch" style="margin-left: 15px;" onclick="funloadgrid();">View</button>
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Uncleared Cheques</span>
                <div id="unclearedChequeProcessingDiv" class="grid-container">
                    <jsp:include page="unclearedChequeProcessingGrid.jsp"></jsp:include>
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Bank Payment</span>
