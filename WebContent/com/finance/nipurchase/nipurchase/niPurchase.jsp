...
$(document).ready(function () {
    ...
    $("#nipurchasedate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
    $("#deliverydate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
    $("#invDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
...
function funNotify(){   
    ...
    for(var i=0; i < rows.length; i++){
        ...
        newTextBox.val(rows[i].srno+"::"+rows[i].qty+" :: "+rows[i].description+" :: "+rows[i].unitprice+" :: "+rows[i].total+" :: "+rows[i].discount+" :: "+rows[i].nettotal+" :: "+rows[i].nuprice+" :: "+rows[i].costtype+" :: "+rows[i].costcode+" :: "+rows[i].remarks+" :: "+rows[i].headdoc+" :: "+rows[i].refrow+" :: "+rows[i].taxper+"::"+rows[i].taxperamt+"::"+rows[i].taxamount+"::");
    ...
    <form id="frmNipurchase" action="saveActionNipurchase" method="post" autocomplete="off">
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Purchase Invoice Info</span>
                ...
                <div class="field-row">
                    ...
                    <select name="nireftype" id="nireftype" style="width:120px;" value='<s:property value="nireftype"/>' onchange="funrefdisslno()">
                ...
                <div class="field-row">
                    ...
                    <input type="text" name="docno" id="docno" style="width:120px;" tabindex="-1" value='<s:property value="docno"/>' readonly>
                </div>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" id="billtype" style="width:80px;">Bill Type</label>
                    <div class="input-search-container" style="width: 125px;">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Terms & Delivery</span>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="justify-content: flex-end; margin-top: 15px; margin-bottom: 0;">
                    ...
                    <input type="text" id="roundof" name="roundof" onblur="funroundof(); funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber (event);" style="width:100px; text-align:right;" value='<s:property value="roundof"/>'/>
                    
                    <label class="lbl-right" style="width:80px; margin-left:15px;">Net Total</label>
                    <input type="text" id="nettotalval" name="nettotalval" style="width:120px; text-align:right;" value='<s:property value="nettotalval"/>' tabindex="-1" readonly />
                </div>
            </div>
