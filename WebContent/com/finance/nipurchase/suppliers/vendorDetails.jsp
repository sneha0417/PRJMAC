...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#jqxVendorDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
    ...
    <form id="frmVendorDetails" action="saveVendorDetails" method="post" autocomplete="off">
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">General Details</span>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtcode" name="txtcode" value='<s:property value="txtcode"/>' style="width:120px;" tabindex="-1" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
                    <input type="text" id="docno" name="txtvendordocno" value='<s:property value="txtvendordocno"/>' style="width:120px;" tabindex="-1" />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:80px;">Name</label>
                    <input type="text" id="txtvendorname" name="txtvendorname" value='<s:property value="txtvendorname"/>' style="flex:1;" />
                </div>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <label class="lbl-right" id="lbltypeentity" style="width:80px; margin-left:auto;">Type</label>
                    <select id="cmbtype" name="cmbtype" style="width:120px;" value='<s:property value="cmbtype"/>'>
                        <option value="">--Select--</option>
                    </select>

                    <label class="lbl-right" id="lbltrnnoentity" style="width:80px; margin-left:auto;">TRN No.</label>
                    <input type="text" id="txtregisteredtrnno" name="txtregisteredtrnno" value='<s:property value="txtregisteredtrnno"/>' style="width:120px;" />
                </div>
            </div>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Account Group</label>
                    <select id="cmbaccgroup" name="cmbaccgroup" style="width:200px;" value='<s:property value="cmbaccgroup"/>'>
                        <option value="">--Select--</option>
                    </select>
                    
                    <label class="lbl-right" style="width:120px; margin-left:auto;">Account</label>
                    <input type="text" id="txtaccount" name="txtaccount" value='<s:property value="txtaccount"/>' style="width:200px;" tabindex="-1" />
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:120px;">Cr. Period Min(Days)</label>
                    <input type="text" id="txtcredit_period_min" name="txtcredit_period_min" value='<s:property value="txtcredit_period_min"/>' style="width:80px; text-align:right;" />
                    
                    <label class="lbl-right" style="width:120px; margin-left:auto;">Cr. Period Max(Days)</label>
                    <input type="text" id="txtcredit_period_max" name="txtcredit_period_max" value='<s:property value="txtcredit_period_max"/>' style="width:80px; text-align:right;" />
                    
                    <label class="lbl-right" style="width:120px; margin-left:auto;">Credit Limit</label>
                    <input type="text" id="txtcredit_limit" name="txtcredit_limit" value='<s:property value="txtcredit_limit"/>' style="width:120px; text-align:right;" />
                </div>
            </div>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtaddress" name="txtaddress" value='<s:property value="txtaddress"/>' style="flex:1;" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Address 2</label>
                    <input type="text" id="txtaddress1" name="txtaddress1" value='<s:property value="txtaddress1"/>' style="flex:1;" />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Tel.</label>
                    <input type="text" id="txttel" name="txttel" value='<s:property value="txttel"/>' style="width:150px;" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Mob.</label>
                    <input type="text" id="txtmob" name="txtmob" value='<s:property value="txtmob"/>' style="width:150px;" onblur="getMobileNoAlreadyExists(this.value,$('#docno').val(),$('#mode').val());" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Office No.</label>
                    <input type="text" id="txtoffice" name="txtoffice" value='<s:property value="txtoffice"/>' style="width:150px;" />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Fax</label>
                    <input type="text" id="txtfax" name="txtfax" value='<s:property value="txtfax"/>' style="width:150px;" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Email</label>
                    <input type="email" id="txtemail" name="txtemail" value='<s:property value="txtemail"/>' placeholder="someone@example.com" style="flex:1;" />
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">Contact Person</label>
                    <input type="text" id="txtcontact" name="txtcontact" value='<s:property value="txtcontact"/>' style="flex:1;" />
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Extn. No.</label>
                    <input type="text" id="txtextno" name="txtextno" value='<s:property value="txtextno"/>' style="width:150px;" />
                </div>
            </div>
