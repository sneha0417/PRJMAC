...
$(document).ready(function () {
    ...
    $("#debitdate").jqxDateTimeInput({ width: '100%', height: '24px', formatString: "dd.MM.yyyy", value: null, theme: 'light' });
...
function loadSearch() {
    ...
    /* Retained Original Mathematical Logic */
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <div id="debitdate" name="debitdate"></div>
                    <input type="hidden" name="hiddebitdate" id="hiddebitdate" value='<s:property value="hiddebitdate"/>'>
                </td>
                
                <td class="lbl-right">A/C No.</td>
                <td><input type="text" name="txtaccountid" id="txtaccountid" value='<s:property value="txtaccountid"/>'></td>
            ...
            <tr>
                ...
                <td><input type="text" name="txtaccountname" id="txtaccountname" value='<s:property value="txtaccountname"/>'></td>
                ...
                <td colspan="3"><input type="text" name="txtdescriptions" id="txtdescriptions" value='<s:property value="txtdescriptions"/>'></td>
            </tr>
        </table>
    </div>
