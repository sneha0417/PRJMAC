...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <select id="cmbtype" name="cmbtype" style="width:80px;" onchange="clearClientInfo();">
            ...
            <input type="text" id="txtaccid" name="txtaccid" placeholder="Press F3" value='<s:property value="txtaccid"/>' onkeydown="getAccType(event);" style="width:120px;" />
            ...
            <select id="cmbcurrency" name="cmbcurrency" style="width:120px;" onchange="getRatevalue(this.value,$('#jqxDebitNoteDate').val());">
                <option></option>
            </select>
            ...
            <input type="text" id="txtrate" name="txtrate" style="width:100px; text-align:right;" value='<s:property value="txtrate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getDrTotal();" tabindex="-1"/>
        </div>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Amount</label>
            <input type="text" id="txtamount" name="txtamount" style="width:120px; text-align:right;" value='<s:property value="txtamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getDrTotal();" />
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Debit-Note Entries</span>
