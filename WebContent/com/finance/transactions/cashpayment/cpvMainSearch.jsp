...
<script type="text/javascript">
    ...
    function getdata(partyname, docNo, date, amount, check){
         $("#refreshdiv").load('cpvMainSearchGrid.jsp?partyname=' + encodeURIComponent(partyname) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="grid-container">
        <div id="refreshdiv">
            <jsp:include page="cpvMainSearchGrid.jsp"></jsp:include>
        </div>
    </div>
