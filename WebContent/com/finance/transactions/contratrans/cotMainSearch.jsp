...
function loadSearch() {
    ...
    var date = "";
    if ($('#contradate').length && typeof $('#contradate').jqxDateTimeInput === 'function') {
        date = $('#contradate').jqxDateTimeInput('val') || "";
    } else {
        var dateEl = document.getElementById("contradate");
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <div id="contradate" name="contradate"></div>
