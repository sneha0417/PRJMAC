...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxUnclearedChequePaymentDate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
    ...
    function openFromAccSearch() {
        var d = $('#jqxUnclearedChequePaymentDate').jqxDateTimeInput('getDate');
        $('#maindate').jqxDateTimeInput('val', d);
        accountFromSearchContent("<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date=" + d);
    }
    ...
    function openToAccSearch() {
        ...
        accountToSearchContent("<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype=" + atype + "&date=" + d);
    }
    /* =============================================== */
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="docno" name="txtunclearedchequepaydocno" value='<s:property value="txtunclearedchequepaydocno"/>' tabindex="-1" style="width:120px;" readonly />
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxUnclearedChequePaymentDate').val());">
                    <option></option>
                </select>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:120px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxUnclearedChequePaymentDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <input type="text" id="txttoamount" name="txttoamount" style="width:120px; text-align:right;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getDrTotal();" />
    ...
    <div style="display:none;">
        ...
        <!-- FIX applied: wrapped maindate in standard hidden div instead of hidden attr -->
