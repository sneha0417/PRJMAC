...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxJournalVouchersDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <label class="lbl-right" style="width:80px;">Import Excel</label>
            <div style="display: flex; align-items: center; gap: 5px;">
                <input type="file" id="fileexcelimport" name="file" style="width: 200px;" />
                <button class="icon" id="btnsearch" name="btnsearch" title="Import Excel" type="button" onclick="return upload();" style="border:none; background:transparent; cursor:pointer; padding:0; display:flex;">
                    <img alt="Import Excel" src="<%=contextPath%>/icons/import_excel.png" style="height:20px;">
                </button>
            </div>
            
            <label id="lblformposted" name="lblformposted" style="font-size: 13px; font-family: Tahoma; color:#6000FC; font-weight:bold; font-style:italic; margin-left:15px; margin-right:auto;">
