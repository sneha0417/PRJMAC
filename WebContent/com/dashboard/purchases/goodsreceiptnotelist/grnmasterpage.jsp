...
JSONToCSVConvertor(datasexcel, 'Goods Receipt Note List', true);
} 
...
<div class="master-container">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="statusselect" name="statusselect">
                                ...
                                <option value="PIV">Executed</option>   
                            </select> 
                        </td>
                    </tr>
                    <tr>
    ...
    <div class="main-content-area">
        <div class="grid-container">
            <div id="listdiv"><jsp:include page="grnlistGrid.jsp"></jsp:include></div>
        </div>
    </div>
