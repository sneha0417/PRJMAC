...
/* Original User Button Styles Retained */
.myButtons {
            ...
            <div class="filter-card">
                <table class="release-filter-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtzone" id="txtzone" placeholder="Press F3 To Search" onKeyDown="getzone(event);" readonly value='<s:property value="txtzone"/>'></td>
                    </tr>
