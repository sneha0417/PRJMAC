...
function loadgrpSearch() {
    var grpname = document.getElementById("assgrp_name").value || "";
...
function getdata(grpname) {
    ...
    $("#assigndiv").load('assignGroupGrid.jsp?id=' + encodeURIComponent(id) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="lbl-right">Group Name</td>
                <td><input type="text" name="assgrp_name" id="assgrp_name" value='<s:property value="assgrp_name"/>'></td>
                
                <td align="left" style="padding-left: 10px;">
                    <input type="button" name="btnrasearch" id="btnrasearch" class="myButton" value="Search" onclick="loadgrpSearch(); return false;">
                </td>
            </tr>
        </table>
    </div>
