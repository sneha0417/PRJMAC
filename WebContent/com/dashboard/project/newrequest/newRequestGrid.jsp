...
<%@page import="com.dashboard.project.newrequest.*"%>
<%
ClsNewRequestDAO sd=new ClsNewRequestDAO();
%>
...
var bttnview='<%=bttnview%>';
            ...
            var source =
            {
                ...
                datafields: [
							{name : 'dtype', type: 'String'  },
     						...
     						{name : 'nrstatusname',type:'string'},
     						{name : 'nrstatus',type:'string'},
 ...
 $("#jqxloaddataGrid").on("bindingcomplete", function (event) {
            ...
            $("#jqxloaddataGrid").jqxGrid(
            {
                ...
                //Add row method
                columns: [
                          { text: 'SL#', sortable: false, filterable: false, editable: false,enabletooltips: true,
					...
					{ text: 'NR STATUS',columntype: 'textbox', width: '12%', datafield: 'nrstatusname',cellclassname:cellclassname },
					...
					{ text: 'CREG',  datafield: 'view',columntype: 'button', width: '7%' },
			...
			//  var claddress=claddress1.replace("/\s/g","%20").replace('#','%23') ;    
             ...
             $('#jqxloaddataGrid').on('rowdoubleclick', function (event) 
            		{ 
		                ...
		                var brch=$("#jqxloaddataGrid").jqxGrid('getcellvalue', rowindex1, "branch");
		            	$('#jobcarddocno').val($('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "refdocno"));
		                ...
		                */
		                var nrstatusname=$('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "nrstatusname");
		                getComments();
		                $('.textpanel p').text('CREG #'+trno+' - '+nrstatusname);
		                $("#followupdiv").load("followupGrid.jsp?docno="+trno+"&brchid="+brch);
