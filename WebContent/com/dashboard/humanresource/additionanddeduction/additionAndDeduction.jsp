...
<script type="text/javascript">
	...
	function funExportBtn(){
		$("#additionAndDeductionDiv").excelexportjs({
			containerid: "additionAndDeductionDiv", 
			datatype: 'json', 
			dataset: null, 
			gridId: "additionAndDeductionGridID", 
			columns: getColumns("additionAndDeductionGridID"),   
			worksheetName:"Addition And Deduction Details"
		});
	} 
	...
	function funreload(event){
		...
		$("#additionAndDeductionDiv").load("additionAndDeductionGrid.jsp?year="+year+"&month="+month+"&empId="+empId+"&acno="+acno+"&check=1"+'&branch='+branch+'&employeebranchchk='+employeebranchchk);
	}
...
<div class="master-container">
    ...
    <div class="sidebar-filters">
        ...
        <div class="sidebar-scroll-content">
            ...
            <!-- Hidden inputs -->
            <select id="cmbleavetype" hidden="true" name="cmbleavetype" value='<s:property value="cmbleavetype"/>'>
                <option value="">--Select--</option>
            </select>
