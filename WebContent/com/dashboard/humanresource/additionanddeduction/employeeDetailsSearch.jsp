...
.grid-container {
	...
	function getdata(employeeName,empId,contactNo, employeebranchchk, branch){
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename='+employeeName.replace(/ /g, "%20")+'&empid='+empId+'&contactno='+contactNo+'&branch='+branch+'&employeebranchchk='+employeebranchchk);
		}
