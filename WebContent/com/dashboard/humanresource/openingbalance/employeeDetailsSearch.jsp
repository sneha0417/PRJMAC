...
<script type="text/javascript">
	$(document).ready(function () {}); 
 	...
 	function loadSearch() {
 		...
 		var id=1;
		getdata(employeeName,empId,contactNo, employeebranchchk, branch, id);
	}
	function getdata(employeeName,empId,contactNo, employeebranchchk, branch, check){ 
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename='+employeeName.replace(/ /g, "%20")+'&empid='+empId+'&id='+check+'&contactno='+contactNo+'&branch='+branch+'&employeebranchchk='+employeebranchchk);
		}
