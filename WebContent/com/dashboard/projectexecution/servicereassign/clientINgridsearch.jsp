...
function getdata(clnames, mob) {
    // Upgraded to robust URL encoding instead of manual string replacement
    $("#refreshdiv1").load('searchClient.jsp?clname=' + encodeURIComponent(clnames) + '&mob=' + encodeURIComponent(mob));
}
</script>
</head>
