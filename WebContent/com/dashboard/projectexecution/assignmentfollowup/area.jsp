...
<%@page import="com.dashboard.projectexecution.assignmentfollowup.ClsAssignmentFollowupDAO"%> 
<%@page import="javax.servlet.http.HttpServletRequest" %>
<%@page import="javax.servlet.http.HttpSession" %>
<% String contextPath=request.getContextPath();%>
 <%ClsAssignmentFollowupDAO DAO= new ClsAssignmentFollowupDAO(); %>
         ...
         //	var url1;
            ...
            //$("#jqxareasearch").jqxGrid('addrow', null, {});
				           ...
				           $('#jqxareasearch').on('rowdoubleclick', function (event) 
				              	...
				              	document.getElementById("txtassignarea").value=$('#jqxareasearch').jqxGrid('getcellvalue', rowindex1, "area");
