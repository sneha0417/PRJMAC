        ...
        $(document).ready(function () { 	
            ...
            $("#jqxpinvGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'InvNo', datafield: 'doc_no',columntype: 'textbox', width: '7%' },
				...
				//	{ text: 'Planned Date',datafield: 'pdate', width: '7%',columntype: 'textbox',cellsformat:'dd.MM.yyyy' },
					{ text: 'RefNo', datafield: 'refno',columntype: 'textbox', width: '8%' },
					{ text: 'Site', datafield: 'site',columntype: 'textbox', width: '10%' },
				//	{ text: 'Site Details', datafield: 'siteadd',columntype: 'textbox', width: '22%' },
					{ text: 'Contract Type', datafield: 'contrtype',columntype: 'textbox', width: '13%' },
					{ text: 'Contract No', datafield: 'contrno',columntype: 'textbox', width: '8%' },
					{ text: 'Name', datafield: 'client',columntype: 'textbox', width: '14%' },
					{ text: 'Description', datafield: 'desc1', width: '15%',aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
					
					{ text: 'Tax Amount',  datafield: 'taxamt',columntype: 'textbox', width: '9%',cellsformat: 'd2', cellsalign: 'right', align: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,hidden:true },
					{ text: 'Amount', datafield: 'invamt',columntype: 'textbox', width: '9%', cellsformat: 'd2', cellsalign: 'right', align: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring },
					{ text: 'Legal Amount', datafield: 'lfee',columntype: 'textbox', width: '8%', cellsformat: 'd2', cellsalign: 'right', align: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring },
					{ text: 'Total Amount', datafield: 'total',columntype: 'textbox', width: '9%', cellsformat: 'd2', cellsalign: 'right', align: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring },
