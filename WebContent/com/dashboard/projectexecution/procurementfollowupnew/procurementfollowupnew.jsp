...
/* Margin to space out stacked grids */
.grid-container {
    margin-bottom: 20px;
}
</style>
...
<div class="master-container">
        ...
        <div class="sidebar-scroll-content">
            ...
            <div class="filter-card">
                ...
                <div class="button-group">
                    <button class="btn-submit" type="button" id="btnreserve" name="btnreserve" onclick="funReserve(event);">Reserve</button>
                    <button class="btn-submit" type="button" id="btnpurchse" name="btnpurchse" onclick="funPurchaseReq(event);">Purchase Request</button>
                    <button class="btn-submit" type="button" id="btnpurchseorder" name="btnpurchseorder" onclick="funPurchaseOrder(event);">Purchase Order</button>
                </div>
                
                <div style="display: none;">
                    <input type="hidden" name="txtvendor" id="txtvendor" value='<s:property value="txtvendor"/>' onKeyDown="getvendor(event);" readonly placeholder="Press F3 to Search">
                    ...
                    <input type="hidden" id="itemdocno" name="itemdocno" value='<s:property value="itemdocno"/>'/>
                    <input type="hidden" id="costranno" name="costranno" value='<s:property value="costranno"/>'/>
                    <input type="hidden" id="prjname" name="prjname" value='<s:property value="prjname"/>'/>
                    <input type="hidden" id="contrtypes" name="contrtypes" value='<s:property value="contrtypes"/>'/>
    ...
    <div class="main-content-area">
        <div class="grid-container">
            <div id="procFolDiv"><jsp:include page="procurementFollowupGrid.jsp"></jsp:include></div>
        </div>
        <div class="grid-container">
            <div id="detailDiv"><jsp:include page="procurementFollowupSubGrid.jsp"></jsp:include></div>
        </div>
    </div>
