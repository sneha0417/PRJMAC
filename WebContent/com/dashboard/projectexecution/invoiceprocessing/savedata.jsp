...
<%
	...
	try{
	     ...
	     while(rs.next()){
			 ...
			 val=srDAO.insert(podates,podates,"PINV-"+docno,"",atype,acno,"", ""+curid,""+rate,"",pono,desc1,session,"A",nettotal,proday,"SRS",request,podates,"",podate,interstate,Double.parseDouble(taxperc));               
