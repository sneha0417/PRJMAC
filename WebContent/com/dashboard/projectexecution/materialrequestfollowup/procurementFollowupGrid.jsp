  ...
  <%@page import="com.dashboard.projectexecution.materialrequestfollowup.ClsMaterialRequestFollowupDAO"%>
<%
ClsMaterialRequestFollowupDAO sd=new ClsMaterialRequestFollowupDAO();
%>
...
<%@page import="javax.servlet.http.HttpSession" %>
 ...
 <%--  dataexcel= '<%= sd.ExcelloadGrid(branchval,fromdate,todate, check) %>';   --%>  
	}
	else{
        ...
        $(document).ready(function () { 	
            ...
            $("#jqxProcFolGrid").jqxGrid(
            {
				...
				//	{ text: 'Site', datafield: 'site', width: '12%',cellclassname:cellclassname },
					...
					{ text: 'Net Total', datafield: 'nettotal', width: '10%',cellclassname:cellclassname , cellsalign: 'right', align: 'right'},
					...
					{ text: 'siteid', datafield: 'siteid', width: '17%' ,hidden:true },
               ...
               $("#overlay, #PleaseWait").hide();
                ...
                $('#jqxProcFolGrid').on('celldoubleclick', function (event) { 
                	...
                	document.getElementById("txtsiteid").value=$('#jqxProcFolGrid').jqxGrid('getcellvalue', rowindex1, "siteid");
                 	  
                 	  /* document.getElementById("txtdocno").value=$('#jqxProcFolGrid').jqxGrid('getcellvalue', rowindex1, "tr_no");
                 	   document.getElementById("txtcldocno").value=$('#jqxProcFolGrid').jqxGrid('getcellvalue', rowindex1, "cldocno");
                 	 	  */
