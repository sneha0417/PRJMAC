...
<td align="right"><label class="branch">Client</label></td>
 ...
 <tr><td  align="center" colspan="2"><input type="button" name="updatdata" id="updatdata" class="myButton" value="Issue" onclick="funupdates()"></td></tr>
         <tr><td colspan="2">&nbsp;</td></tr>
...
<td width="80%">
 	...
 	<table width="100%" > 
		<tr>
			 <td><div id="listdiv1" hidden="true"><jsp:include page="listGrid.jsp"></jsp:include></div></td>
			 
			 
		</tr>
		
				<tr>
			 <td><div id="listdiv2" hidden="true"><jsp:include page="estconfirmGrid.jsp"></jsp:include></div></td>
