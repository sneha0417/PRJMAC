...
function invloadSearch1() {
    var clnamess = document.getElementById("Cl_names").value || "";
    var contno = document.getElementById("contno").value || "";
    var invtype = document.getElementById("invtype").value || "";
    
    getdata1(clnamess, contno, invtype);
}

function getdata1(clnames, contno, invtype) {
    // Upgraded to encodeURIComponent for safety
    $("#refreshdivmas").load('contractsubMastersearch.jsp?Cl_names=' + encodeURIComponent(clnames) + 
