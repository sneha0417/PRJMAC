	...
	try{
		...
		for(int j=0;j<vndarray.size();j++){
			...
			if(!(docno.equalsIgnoreCase(""))){
				...
				value=viewDAO.insert(fdate, fdate, "DIR", 0, "AP", clacno, refname, "1", "1", "", "", "", session, "A", vndtotal, gridarray, "CPU", request, fdate, invno,invdate, 1,  0.0,vndtotal);
			...
			while(rg.next()) {
						...
						if(type.equalsIgnoreCase("CASH-VAT")){
							...
							journalvouchersarray.add(acno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+baseamt+" :: "+baseamt+" ::"+ 2 +" :: "+1+" :: "+""+" :: "+""+" :: ");
						...
						if(type.equalsIgnoreCase("CASH")){
							...
							journalvouchersarray.add(expacno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+baseamt+" :: "+baseamt+" ::"+ 2 +" :: "+1+" :: "+""+" :: "+""+" :: ");
							expval=expval+baseamt;  
							typeid=1;      
						}
						if(type.equalsIgnoreCase("HR")){   
							...
							journalvouchersarray.add(acno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+baseamt+" :: "+baseamt+" ::"+ 2 +" :: "+1*-1+" :: "+""+" :: "+""+" :: ");
							hrtypeid=2;      
						}
						if(type.equalsIgnoreCase("PAYABLE")){   
							payamt=payamt+baseamt; 
							if(baseamt>0){   
								baseamt=baseamt*-1;
							}  
							journalvouchersarray.add(payacno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+baseamt+" :: "+baseamt+" ::"+ 2 +" :: "+1*-1+" :: "+""+" :: "+""+" :: ");
							paytypeid=3;               
						}
						if(type.equalsIgnoreCase("CASH") || type.equalsIgnoreCase("CASH-VAT")){
		            ...
		            if(typeid==1){   
						...
						journalvouchersarray.add(advacno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+advamount+" :: "+advamount+" ::"+ 2 +" :: "+1*-1+" :: "+""+" :: "+""+" :: ");
					    ...
					    if(expval!=0){     	
							 ...
							 journalvouchersarray.add(cashacno+" :: "+description+" :: "+ 1 +" :: "+ 1 +" :: "+expval+" :: "+expval+" ::"+ 2 +" :: "+1*-1+" :: "+""+" :: "+""+" :: ");
					    }
				     }  
		            if(hrtypeid==2){
		            	if(hramt<0){     
