		...
		//System.out.println("sql2vendor fetch========"+sql2);
		 ...
		 for(int j=0;j<vndarray.size();j++){
			...
			if(!(docno.equalsIgnoreCase(""))){
				...
				value=viewDAO.insert(fdate, fdate, "DIR", 0, "AP", clacno, refname, "1", "1", "", "", "Multiple Cash Purchase", session, "A", vndtotal, gridarray, "CPU", request, fdate, invno,invdate, 1,  0.0,vndtotal);
