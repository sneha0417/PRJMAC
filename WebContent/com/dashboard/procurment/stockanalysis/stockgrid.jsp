...
<script type="text/javascript">
       ...
       var type='<%=type%>';
	  	...
	  	if(type=='1'){ 
	  		...
	  		partdata='<%=dao.stockLedgerSummary(session,hidbrand,fromDate,toDate,hidtype,hidcat,hidsubcat,hidproduct,branchid,hidept,load,prodgroupby,hidlocid)%>';  
	  	} 
		else{
		partdata;
	}
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                    ...
                    { text: 'Branch', datafield: 'branch',  width: '10%',hidden:true },
           	         { text: ' CODE', datafield: 'pno',pinned: true,  width: '12%'  ,cellclassname:'advanceClass'}, 
					 ...
					 { text: 'QUANTITY',datafield: 'opnqty', width: '8%', cellsformat: 'd2',columngroup:'opening'  ,cellclassname:'balanceClass' },
					 ...
					 { text: 'QUANTITY',datafield: 'inqty', width: '8%', cellsformat: 'd2',columngroup:'in' ,cellclassname:'advanceClass4'  },
				     ...
				     { text: 'QUANTITY',datafield: 'isqty', width: '8%', cellsformat: 'd2',columngroup:'issued' ,cellclassname:'sl'  },
					 ...
					 { text: 'QUANTITY', datafield: 'balqty', width: '8%', cellsformat: 'd2',columngroup:'balance'  ,cellclassname:'advanceClass3'  },
