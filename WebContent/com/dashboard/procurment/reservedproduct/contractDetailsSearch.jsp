...
.modern-ui table {
    ...
    border-spacing: 8px 8px; /* Slightly increased vertical spacing for stacked layout */
    width: 100%;
    table-layout: fixed; 
}
...
div#search.modern-ui input#btnsearch.myButton {
    ...
    width: 120px !important; /* Fixed width prevents it from spanning the whole row */
...
function loadContractSearch() {
    // Using fallbacks to ensure no null reference errors
