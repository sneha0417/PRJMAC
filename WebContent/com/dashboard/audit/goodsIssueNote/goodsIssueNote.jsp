...
function funreload(event)
{
	 ...
	 $("#listdiv").load("goodsIssueNoteGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate);
			 ...
			 if(parseInt(items)>=1)
				 {
					...
					// $("#listdiv").load("salesqotfolowupGrid.jsp?docno="+docno);
					 $("#goodsIssueNoteGrd").jqxGrid('clear');
					 $('#docno').val("");
					 $('#audit').attr('disabled',true);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="goodsIssueNoteGrid.jsp"></jsp:include></div></td>
		</tr>
		<tr>
			 <td><div id="listDetailDiv"><jsp:include page="goodsIssueNoteGridDetail.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
