...
<div class="master-container">
    ...
    <div class="main-content-area">
        <div class="grid-container">
            <div id="listdiv"><jsp:include page="puchaseorderreportGrid.jsp"></jsp:include></div>
        </div>
        <div class="grid-container">
            <div id="listdetdiv"><jsp:include page="puchaseorderreportdetailsGrid.jsp"></jsp:include></div>
        </div>
    </div>
