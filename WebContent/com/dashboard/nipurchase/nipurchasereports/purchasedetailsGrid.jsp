        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                    ...
                    { text: 'Branch', datafield: 'branchname', width: '8%' },
         			...
         			{ text: 'Vender', datafield: 'account', width: '6%' },
         			
         			 
				     	 
		             
				     
					 { text: 'Name', datafield: 'accname',aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
					 
					 { text: 'Account', datafield: 'acc', width: '6%' },
					 { text: 'Type', datafield: 'atype', width: '3%' },
					 { text: 'Account Name', datafield: 'accntt', width: '6%' },
					 { text: 'Description', datafield: 'desc1', width: '6%' },
					 { text: 'Qty', datafield: 'qty', width: '5%' ,hidden:false  },
