    ...
    $("#orderlist").jqxGrid(
    {
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                    ...
                    { text: 'Branch', datafield: 'branchname', width: '18%' },
