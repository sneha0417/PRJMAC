...
function getdata(partyname, accNo, contactNo) {
    // Upgraded to robust URL encoding. Hardcoded atype=AR and check=1 are preserved in the URL string.
    $("#refreshdiv").load('clientAccountDetailsSearchGrid.jsp?atype=AR' + 
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><input type="text" name="txtcontactno" id="txtcontactno" value='<s:property value="txtcontactno"/>'></td>
