...
function getclinfo(event){
     ...
     function funExportBtn(){
  	   ...
  	   JSONToCSVCon(pendingdataexcel,'Pending Contract',true);
...
function funreload()
{
    ...
    if(id>0){
    	$("#pcdiv").load("pendingContractDetails.jsp?clientid="+clientid+"&date="+date+"&barchval="+barchval+"&dtype="+dtype+"&id="+id+"&cstatus="+cstatus);
	   ...
	   function funClear(){
			$("#jqxpendcontrGrid").jqxGrid('clear'); 
			$("#jqxpendcontrGrid").jqxGrid('addrow', null, {});
