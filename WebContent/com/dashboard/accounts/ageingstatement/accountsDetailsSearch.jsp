...
$(document).ready(function () {
    // Safely pull from parent element if it exists in the DOM
    var cmbTypeSelect = $('#cmbtype');
    if (document.getElementById("txtatype") && cmbTypeSelect.length) {
        document.getElementById("txtatype").value = cmbTypeSelect.val();
    }
}); 
...
function getdata(atype, partyname, accNo, contactNo) {
    // Upgraded to robust URL encoding. Hardcoded check=1 is preserved.
