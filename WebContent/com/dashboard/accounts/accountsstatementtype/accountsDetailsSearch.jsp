...
$(document).ready(function () {
    // Safely check label text and update properties using .prop() instead of .attr()
    var lblDetailName = $('#lbldetailname').text().trim();
    var txtContactNo = $('#txtcontactno');
    var txtAType = $('#txtatype');
    
    if (lblDetailName === 'Accounts Statement AP') {
        txtAType.val('AP');
        txtContactNo.prop('readonly', false);
    } else if (lblDetailName === 'Accounts Statement AR') {
        txtAType.val('AR');
        txtContactNo.prop('readonly', false);
    } else if (lblDetailName === 'Accounts Statement GL') {
        txtAType.val('GL');
        txtContactNo.prop('readonly', true);
    } else if (lblDetailName === 'Accounts Statement HR') {
        txtAType.val('HR');
        txtContactNo.prop('readonly', true);
    }
}); 
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><input type="text" name="txtaccountno" id="txtaccountno" value='<s:property value="txtaccountno"/>'></td>
