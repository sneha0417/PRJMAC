...
$(document).ready(function () {
    // Safely check for cmbtype in case it is on a parent frame
    var cmbtypeVal = $('#cmbtype').length ? $('#cmbtype').val() : '';
    
    if (document.getElementById("txtatype")) {
        document.getElementById("txtatype").value = cmbtypeVal;
    }

    // Using .prop() instead of .attr() for modern jQuery compatibility
    if (cmbtypeVal == 'GL' || cmbtypeVal == 'HR') {
