...
$(document).ready(function () {
    ...
    // Consolidated label and readonly logic
    var $txtregno = $('#txtregno');
    var $lblregno = $('#lblregnositename');

    if (costTypeText === 'Fleet' || costTypeText === 'Job card') {
        $txtregno.prop('readonly', false);
        $lblregno.text("Reg No");
    } else if (costTypeText === 'AMC' || costTypeText === 'SJOB' || costTypeText === 'Ticket No') {
        $txtregno.prop('readonly', false);
        $lblregno.text("Site");
    } else {
        $txtregno.prop('readonly', true);
        $lblregno.text("Reg No"); // Default state
    }
}); 
...
function getdata(type, costCode, costCodeName, RegNo, check) {
    // Using encodeURIComponent instead of manual string replaces
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td class="lbl-right"><label id="lblregnositename">Reg No</label></td>
                <td>
