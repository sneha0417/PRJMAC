...

{
	...
	function funupdate()
	{
	   ...
	   for(var i=0 ; i < selectedrows.length ; i++){ 
		   list.push($("#duedetailsgrid").jqxGrid('getcellvalue',selectedrows[i],'rowno')+"::"+$("#duedetailsgrid").jqxGrid('getcellvalue',selectedrows[i],'qty')+"::"+$("#duedetailsgrid").jqxGrid('getcellvalue',selectedrows[i],'foc')+"::");
...
/* 		   
...

	{
		...
		x.onreadystatechange=function(){
		  ...
		  x.open("GET","savedata.jsp?list="+list+"&masterdoc_no="+masterdoc_no+"&branchvals="+branchvals+"&date="+$("#date").val()+"&refnos="+document.getElementById("refnos").value+"&description="+document.getElementById("description").value+"&locationid="+document.getElementById("locationid").value); 
		x.send();
	}
...
<td align="right"><label class="branch">Customer</label></td>
  ...
  <tr><td colspan="2">&nbsp;</td></tr> 
    <tr><td colspan="2">&nbsp;</td></tr> 
      <tr><td colspan="2">&nbsp;</td></tr> 
    <tr><td colspan="2" align="center"><input type="hidden" class="myButton" name="updatdata" id="updatdata"  value="Update" onclick="funupdate()"></td></tr> 
      <tr><td colspan="2">&nbsp;</td></tr> 
   <tr><td colspan="2">&nbsp;</td></tr> 
            <tr><td colspan="2">&nbsp;</td></tr> 
    ...
    <table width="100%" hidden="true">
     ...
     <tr><td  align="right" ><label class="branch"> </label></td><td align="left"><div id='date'  name='date' value='<s:property value="date"/>'></div></td></tr>
  ...
  <td ><input type="text" id="txtlocation" name="txtlocation" style="height:20px;width:100%;"  readonly="readonly" placeholder="Press F3 to Search" value='<s:property value="txtlocation"/>' onkeydown="getLocation(event);"/>
     ...
     <tr><td  align="right" ><label class="branch"> </label></td><td align="left"><input type="text" name="refnos"   style="height:20px;width:100%;" id="refnos" value='<s:property value="refnos"/>'  > </td></tr>
        <tr><td  align="right" ><label class="branch"> </label></td><td align="left"><input type="text" name="description" style="height:20px;width:100%;" id="description" value='<s:property value="description"/>'  > </td></tr>
