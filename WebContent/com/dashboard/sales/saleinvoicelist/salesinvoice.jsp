...
function funExportBtn(){
	if (document.getElementById('rsumm').checked) {
	 //  $("#stocklistgrid").jqxGrid('exportdata', 'xls', 'Strock List');
		...
		JSONToCSVCon(sumdatass, 'Sales Invoice', true);
			...
			JSONToCSVCon(dat, 'Sales Invoice', true);
...
<%--    <tr><td colspan="2">&nbsp;</td></tr> 
	 	<tr hidden="true"><td align="right"  hidden="true"> <label class="branch" hidden="true"></label></td> <td hidden="true"><select hidden="true" id="statusselect" name="statusselect" style="width:70%;">
