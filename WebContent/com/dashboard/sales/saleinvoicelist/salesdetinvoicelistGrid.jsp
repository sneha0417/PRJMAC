...
{ 
	 ...
	 dat='<%=searchDAO.saleslistsearchdetex(barchval,fromdate,todate,statusselect,acno,psrno,invdocnomaster,hidbrand,hidtype,hidproduct,hidcat,hidsubcat,hidept,load)%>'; 
	 
	 
	 datas='<%=searchDAO.saleslistsearchdet(barchval,fromdate,todate,statusselect,acno,psrno,invdocnomaster,hidbrand,hidtype,hidproduct,hidcat,hidsubcat,hidept,load)%>'; 
        ...
        columns: [   
        		...
        		/* 	 { text: 'Mode Of Pay',datafield: 'paymode', width: '6%' },
          	      ...
          	      { text: 'Brand Name', datafield: 'brandname',  width: '15%' },
          	         ...
          	         { text: 'Foc', datafield: 'foc',  width: '6%' ,cellsformat:'d2',aggregates: ['sum1'],aggregatesrenderer:rendererstring1},
