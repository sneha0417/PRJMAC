...
function funreload(event)
{
    ...
    // alert("acno==="+acno);
	  ...
	  $("#listdiv").load("deliverynoteGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&acno="+acno);
	  //$("#dellistgrid").jqxGrid('clear');
		   }
	}
function getBranch1() {
...
function funval()
{
  ...
  return 0;
   ...
   for(var i=0 ; i < selectedrows.length ; i++){ 
	   lists.push($("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'rowno')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'qty')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'foc')+"::");
	...
	function funsavedatats()
	{
	  ...
	  return 0;
	    ...
	    for(var i=0 ; i < selectedrows.length ; i++){ 
		   ...
		   list.push($("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'prodoc')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'unitdocno')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'qty')+"::"+"0"+"::"+"0"+"::"
				   +$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'unitprice')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'total')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'disper')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'discount')+"::"
				   +$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'nettotal')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'specid')+"::"+"0"+"::"+"0"+"::"+"0"+"::"+"0"+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'locid')+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'taxper')+"::"
				   +$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'nettaxamount')+"::"+"0"+"::"+000+"::"+"0"+"::"+"0"+"::"+$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[i],'taxamount')+"::"+"0000"+"::");
				 ...
				 var items= x.responseText;
				 	...
				 	var chkd=itemval[1];
				 	 	  if(chk>0)
				 	 		 ...
				 	 		 $.messager.alert('Message', 'Successfully Generated Doc No:'+chkd);
				 	 		funreload(event);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="deliverynoteGrid.jsp"></jsp:include></div></td>
		</tr>
