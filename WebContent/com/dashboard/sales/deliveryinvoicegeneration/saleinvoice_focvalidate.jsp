...

{
...

	{
		...
		x.onreadystatechange=function(){
		  ...
		  x.open("GET","savedata.jsp?list="+list+"&masterdoc_no="+masterdoc_no+"&branchvals="+branchvals+"&date="+$("#date").val()+"&duedate="+$("#duedate").val()+"&refnos="+document.getElementById("refnos").value+"&description="+document.getElementById("description").value+"&locationid="+document.getElementById("locationid").value+"&list1="+list1); 
		x.send();
	}
...
<td align="right"><label class="branch">Customer</label></td>
  ...
  <td ><input type="text" id="txtlocation" name="txtlocation" style="height:20px;width:100%;"  readonly="readonly" placeholder="Press F3 to Search" value='<s:property value="txtlocation"/>' onkeydown="getLocation(event);"/>
     ...
     <tr><td colspan="2"><div id="sidelistdiv"><jsp:include page="sublistGrid.jsp"></jsp:include></div></td></tr> 
        <tr><td colspan="2" align="center"><input type="button" class="myButton" name="updatdata" id="updatdata"  value="Update" onclick="funupdates()"></td></tr>
