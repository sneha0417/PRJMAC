...
{ 
	 ...
	 datas='<%=searchDAO.salereturnlistsearch(barchval,fromdate,todate,statusselect,acno)%>';
	 
	 datass='<%=searchDAO.salereturnlistsearchex(barchval,fromdate,todate,statusselect,acno)%>';
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                     ...
                     { text: 'Account Name', datafield: 'acname',  width: '12%'  },
           	         ...
           	         { text: 'Qty', datafield: 'qty',  width: '6%' ,cellsformat:'d2',aggregates: ['sum1'],aggregatesrenderer:rendererstring1},
		             ...
		             { text: 'Tax %', datafield: 'taxper',  width: '10%' ,cellsformat:'d2',cellsalign: 'right', align:'right'},
		           	 { text: 'Tax Amount', datafield: 'taxamount',  width: '10%' ,cellsformat:'d2',cellsalign: 'right', align:'right'},	
