...
function funExportBtn(){
	   $("#enquirylist").jqxGrid('exportdata', 'xls', 'Enquiry process');
	 }
...
function funreload(event)
{
	 ...
	 var todate= $("#todate").val();
	  ...
	  $("#listdiv").load("enquirylistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate);
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr><td colspan="2">&nbsp;</td></tr>
 	 ...
 	 <tr><td colspan="2">&nbsp;</td></tr> 
	 <tr><td colspan="2">&nbsp;</td></tr>  
  <tr><td width="6%" align="right"><label class="branch" id="branchlabel">Branch</label></td>
		<td width="94%"><select id="cmbbranch1" name="cmbbranch1" style="width: 50% ;   "value='<s:property value="cmbbranch1"/>'>
      <option value="">--Select--</option></select> &nbsp;&nbsp;&nbsp;<input type="Button" class="myButton1" id="searchgrid" value="Search" onclick="searchGrid()">
      <input type="hidden" id="hidcmbbranch1" name="hidcmbbranch1" value='<s:property value="hidcmbbranch1"/>' /></td></tr> 
 <tr><td colspan="2" align="center"></td></tr> 
  <tr><td colspan="2">&nbsp;</td></tr> 
  <tr><td colspan="2">&nbsp;</td></tr> 
 <tr><td colspan="2" align="center"><input type="Button" class="myButton" id="create" value="Generate Quote" onclick="quotecreate()"></td></tr> 
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="enquirylistGrid.jsp"></jsp:include></div></td>
		</tr>
