	    ...
	    <div class="container-fluid">     
	        <div class="row rowgap">   
            		...
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">  
            			<div id="invdate" style="border: 1px solid black" placeholder="" style="width:69%;"></div> 
					</div>  
        </div>  
        <div class="row rowgap">   
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">Description</div>  
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">  
            			 <textarea class="textarea-simple-1" style="width:100%;height:80px;" placeholder="Description" id="invdesc"></textarea>
					</div>  
        </div>
		</div>
		<div class="clear"></div>    
      ...
      <div class="modal-body"> 
	    <div class="container-fluid">     
	        <div class="row rowgap">   
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">Inv Date</div>        
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">  
            			<div id="invprocessdate" style="border: 1px solid black" placeholder="" style="width:69%;"></div>   
					</div>  
        </div>  
        <div class="row rowgap">   
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">Description</div>  
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">  
            			 <textarea class="textarea-simple-1" style="width:100%;height:80px;" placeholder="Description" id="invprocessdesc"></textarea>
					</div>  
        </div>
        <div class="row rowgap">   
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">Notes</div>          
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
            			 <textarea class="textarea-simple-1" style="width:100%;height:80px;" placeholder="Notes" id="invnotes"></textarea>
					</div>  
        </div>
		</div>
		<div class="clear"></div>    
  ...
  /*   	document.getElementById("schtrno").value="";  
	...
	function funProformaInvoice(){    
		 ...
		 $.messager.confirm('Confirm', 'Do you want to Generate Invoice?', function(r){       
	 			if (r){
	 				saveProformaInvoice(invdate,invdesc,jobdocno,pdrowno,brhid);           
	 			}
		 });
	
	 }    
	
     function saveProformaInvoice(invdate,invdesc,jobdocno,pdrowno,brhid){          	
        var x=new XMLHttpRequest();
		x.onreadystatechange=function(){
			if (x.readyState==4 && x.status==200)
			{
		...
		x.open("GET","saveProformaInvoice.jsp?invdate="+invdate+"&invdesc="+encodeURIComponent(invdesc)+"&jobdocno="+jobdocno+"&pdrowno="+pdrowno+"&brhid="+brhid,true);    
		x.send();  
   }
 	...
 	function funinvoiceprocessing(){      
		 ...
		 $.messager.confirm('Confirm', 'Do you want to Generate Invoice?', function(r){       
	 			if (r){
	 				saveinvoiceprocessing(invdate,invdesc,jobdocno,pdrowno,brhid,invnotes);                 
	 			}
		 });   
	
	 }    
	
    function saveinvoiceprocessing(invdate,invdesc,jobdocno,pdrowno,brhid,invnotes){            	
       var x=new XMLHttpRequest();
		x.onreadystatechange=function(){
			if (x.readyState==4 && x.status==200)
			{
				...
				if(parseInt(items[0])>0){     
					swal({
						type: 'success',
						title: 'Success',
						text: 'PJIV - '+items[1]+' Successfully Generated'           
					});
		...
		x.open("GET","saveInvoiceProcessing.jsp?invdate="+invdate+"&invnotes="+encodeURIComponent(invnotes)+"&invdesc="+encodeURIComponent(invdesc)+"&jobdocno="+jobdocno+"&pdrowno="+pdrowno+"&brhid="+brhid,true);    
		x.send();  
  } 
