...
.btn-primary {
    width: 100%;
    height: 28px;
    background-color: #1e6bf2; /* Exact vibrant blue from upload */
    border: none;
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            for (var i = 0; i < process.length; i++) {
                optionsbranch += '<option value="' + srno[i].trim() + ':'+ process[i].trim() +'">' + process[i] + '</option>';
            }
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            for (var i = 0; i < salItems.length; i++) {
                optionssal += '<option value="' + salIdItems[i].trim() + '">' + salItems[i] + '</option>';
            }
            ...
            if ($('#hidcmbsalesman').val() != null && $('#hidcmbsalesman').val() != "") {
...
<div class="master-container">
                ...
                <table class="release-filter-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <label style="display: flex; align-items: center; cursor: pointer; gap: 5px;">
                                ...
                                <span style="font-size: 11px; color: #4e5e71; font-weight: 500;">Enable FollowUp</span>
                            </label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="search-input-wrapper">
                                <input type="text" id="txtarea" name="txtarea" readonly="readonly" placeholder="Double click to search" value='<s:property value="txtarea"/>' onKeyDown="getareas(event);" ondblclick="getareas(event);" />
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <textarea id="info" name="info" readonly="readonly" style="height:50px; margin-top:5px;"><s:property value="info"></s:property></textarea>
                        </td>
                    </tr>
    ...
    <div class="main-content-area">
        <div style="margin-bottom: 15px;">
            <div id="enquiryfollowupDiv"><jsp:include page="enquiryfollowupGrid.jsp"></jsp:include></div>
        </div>
        <div>
