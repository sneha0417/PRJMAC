	...
	function createSurvey(){
		...
		var path1="com/project/execution/surveyDetails/surveydet.jsp";  
		 var name="Survey Details";
		  ...
		  +"&refdocno="+refdocno+"&reftrno="+reftrno+"&clientdet="+clientdet.replace("/\s/g","%20").replace('#','%23').replace('&','%26')+"&cpersonid="+cpersonid+"&cperson="+cperson.replace("/\s/g","%20").replace('#','%23').replace('&','%26')
		  +"&cpersondet="+cpersondet.replace("/\s/g","%20").replace('#','%23').replace('&','%26');   
