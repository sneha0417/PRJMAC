...
<%-- Fixed: Moved the link tag OUTSIDE of the style block --%>
...
$(document).ready(function () {
    // Initialization logic (uncomment datepicker if needed later)
...
function getdata(clname, mob) {
    var id = 1;
    // Upgraded: Using encodeURIComponent ensures ALL spaces and special chars are handled, not just the first space
...
<div id="search" class="modern-ui">
    ...
    <div class="grid-container">
        <div id="refreshdiv1">
            <%-- Target remains searchClient.jsp as per your original file --%>
