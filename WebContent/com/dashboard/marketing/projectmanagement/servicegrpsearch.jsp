 ...
 assignfrm='<%=DAO.assignfrm(session)%>'; 
        ...
        $(document).ready(function () { 
         //	var url1;
            ...
            $("#jqxgrpsearch").jqxInput({ source: dataAdapter, displayMember: "grpcode", valueMember: "doc_no", items: 20 ,width: 170, height: 20});
    ...
    <input  type="text" id="jqxgrpsearch" onchange="inputload();"/>
    </body>
</html>