...
<%
	...
	try{
        ...
        while (resultSet.next()) {
		 ...
		 if(dataExist==0){
	     	sql2="insert into gl_biblog (doc_no, brhId, dtype, edate, userId, ENTRY) values ('"+docNo+"','"+session.getAttribute("BRANCHID").toString()+"','PJM',now(),'"+session.getAttribute("USERID").toString()+"','A')";
