...
ClsCommon ClsCommon=new ClsCommon();
	...
	try{
		...
		String branchid=session.getAttribute("BRANCHID").toString();
			 ...
			 strSql = "update cm_servplan set empGroupId="+groupid+", empId="+grpempid+", asgnMode="+assignid+" ,remarks='"+desc+"',plannedon='"+sdate+"',date='"+sdate+"',pltime='"+ptime+"' where TR_NO="+srno+" and refdocno="+trno+" and dTYPE='"+dtype+"' and status=4 "+sql1+"";      
		...
		if(rs>0){
			 ...
			 String sqls="insert into gl_biblog (doc_no, brhId, dtype, edate, userId, ENTRY) values ('"+trno+"','"+branchid+"','AMCM',now(),'"+userid+"','E')";
