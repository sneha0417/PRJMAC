...
<form  method="post" autocomplete="off">      
  ...
  <input type="hidden" name="tempassignname" id="tempassignname">               
...
<script type="text/javascript">   
    $(document).ready(function(){    
        ...
        $('#btnassignment').click(function(){   
        	var enqno=$('#jobdocno').val(); tempassignname
        	var tempassignname=$('#tempassignname').val();
	    	if(enqno==""){
	    		swal({
					type: 'warning',
					title: 'Warning',
	    	...
	    	document.getElementById("jqxgrptosearch").value=tempassignname;   
    ...
    function clearfields(){
	    ...
	    document.getElementById("tempassignname").value="";
    }   
