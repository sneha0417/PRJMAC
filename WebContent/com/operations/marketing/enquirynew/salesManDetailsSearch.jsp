...
function loadSearch() {
    ...
    getdatas(slnames, mob);
}

function getdatas(slname, mob) {
    var id = 1;
    // Upgraded to robust URL encoding instead of manual string replacement
    $("#refreshdiv2").load('salesManDetailsSearchGrid.jsp?slname=' + encodeURIComponent(slname) + 
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><input type="text" name="sal_name" id="sal_name" value='<s:property value="sal_name"/>'></td>
