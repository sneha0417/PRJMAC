...
<script type="text/javascript">
     $(document).ready(function () {
         ...
         $("#dateout").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         $("#closedate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         $("#dateouthidden").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
         $("#garagedeldate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         $("#garagecollectdate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         ...
         $("#hiddelivery").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         $("#hidcollect").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", value:null, theme: 'energyblue'});
         
         /* force internal alignment AFTER render */
         setTimeout(function () {
             $("[id^='date'], [id^='close'], [id^='garage'], [id^='time'], [id^='hid']").find("input").css({
                 "margin-top": "0px",
                 "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
             ...
             $("[id^='date'], [id^='close'], [id^='garage'], [id^='time'], [id^='hid']").find(".jqx-action-button").css({
                 "top": "0px",
                 "height": "24px"
             });
         }, 0);
     ...
     $('#txtfleetno').dblclick(function(){ openFleetSearch(); });
     $('#driver').dblclick(function(){ openDriverSearch(1); });
     $('#staff').dblclick(function(){ openStaffSearch(1); });
     $('#garage').dblclick(function(){ openGarageSearch(); });
     $('#closestaff').dblclick(function(){ openStaffSearch(2); });
     $('#closedriver').dblclick(function(){ openDriverSearch(2); });
    ...
    function openDriverSearch(id) {
        if(id == 1 && document.getElementById("mode").value=="A"){
        ...
        } else if(id == 2 && document.getElementById("mode").value=="close"){
             $('#driverwindow').jqxWindow('open');
            $('#driverwindow').jqxWindow('focus');
    ...
    function openStaffSearch(id) {
        if(document.getElementById("mode").value=="A"){
            $('#staffwindow').jqxWindow('open');
            $('#staffwindow').jqxWindow('focus');
            staffSearchContent("staffSearch.jsp?id=" + id, $('#staffwindow'));
        }
    }
    
    function openGarageSearch() {
        if(document.getElementById("mode").value=="A"){
    ...
    function checkfuturetime(date,time){
     ...
     function checkStaff(){
         ...
         if(temp=="ST"){
             document.getElementById("garage-container").style.display="none";
             document.getElementById("staff-container").style.display="flex";
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <label class="lbl-right" style="width:80px; margin-left:15px;">Fleet No</label>
            ...
            <input type="text" id="txtfleetname" name="txtfleetname" style="flex:1; margin-left:10px;" value='<s:property value="txtfleetname"/>' readonly="readonly"/>
        ...
        <div class="field-row">
            ...
            <select name="cmblocation" id="cmblocation" style="width:140px;">
                <option value="">--Select--</option>
            </select>
            <input type="hidden" id="hiddateout" name="hiddateout" value='<s:property value="hiddateout"/>'/>
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Date Out</label>
            <div style="width: 125px;">
            ...
            <label class="lbl-right" style="width:40px; margin-left:15px;">KM</label>
            <input type="text" id="outkm" name="outkm" style="width:80px; text-align:right;" value='<s:property value="outkm"/>'/>
            
            <label class="lbl-right" style="width:40px; margin-left:15px;">Fuel</label>
        ...
        <div class="field-row">
            ...
            <select id="cmbstatus" name="cmbstatus" style="width:125px;" onchange="checkStaff();" value='<s:property value="cmbstatus"/>' >
                <option value="">-Select-</option>
            </select>
            <input type="hidden" id="hidcmbstatus" name="hidcmbstatus" value='<s:property value="hidcmbstatus"/>'/>
            
            <div id="staff-container" style="flex:1; display:flex; align-items:center; margin-left:15px;">
                ...
                <div class="input-search-container" style="flex:1;">
                    ...
                    <svg class="magnifier-icon" onclick="openStaffSearch(1);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            </div>
            
            <div id="garage-container" style="flex:1; display:flex; align-items:center; margin-left:15px;">
                ...
                <div class="input-search-container" style="flex:1;">
                    ...
                    <svg class="magnifier-icon" onclick="openGarageSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
        ...
        <div class="field-row">
            ...
            <div class="input-search-container" style="width: 125px;">
                ...
                <svg class="magnifier-icon" onclick="openDriverSearch(1);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            ...
            <label class="lbl-right" style="width:50px; margin-left:15px;">User</label>
            <input type="text" id="outuser" name="outuser" style="width:120px; text-transform:uppercase;" value='<s:property value="outuser"/>' />
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        ...
        <div id="deliveryfield" class="middle-panel" style="flex: 1; margin-bottom: 0; display:none;">
            ...
            <div class="field-row">
                ...
                <input type="text" name="garagedeliverykm" id="garagedeliverykm" style="width:125px; text-align:right;" value='<s:property value="garagedeliverykm"/>' onkeypress="javascript:return isNumber (event,id)">
                ...
                <select name="cmbgaragedeliveryfuel" id="cmbgaragedeliveryfuel" style="width:100px;">
                    ...
                    <option value=0.125>Level 1/8</option><option value=0.250>Level 2/8</option><option value=0.375>Level 3/8</option>
                    <option value=0.500>Level 4/8</option><option value=0.625>Level 5/8</option><option value=0.750>Level 6/8</option>
                    <option value=0.875>Level 7/8</option><option value=1.000>Level 8/8</option>
                </select>
                
                <input type="button" name="btndeliveryupdate" id="btndeliveryupdate" class="myButton" style="margin-left: auto;" value="Update" onclick="funDeliveryUpdate();">
                <input type="button" name="btndeliverysave" id="btndeliverysave" class="myButton" style="margin-left: auto; display:none;" value="Save" onclick="funDeliverySave();">
            </div>
        </div>

        <div id="collectionfield" class="middle-panel" style="flex: 1; margin-bottom: 0; display:none;">
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:50px;">KM</label>
                <input type="text" name="garagecollectkm" id="garagecollectkm" style="width:125px; text-align:right;" value='<s:property value="garagecollectkm"/>' onkeypress="javascript:return isNumber (event,id)">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <label class="lbl-right" style="width:80px; margin-left:15px;">Location</label>
            <select name="cmbcloselocation" id="cmbcloselocation" style="width:140px;">
                <option value="">--Select--</option>
            </select>
            ...
            <label class="lbl-right" style="width:40px; margin-left:15px;">KM</label>
            <input type="text" id="closekm" name="closekm" style="width:80px; text-align:right;" value='<s:property value="closekm"/>' onKeyPress="javascript:return isNumber (event,id)" onBlur="getTotalkm();"/>
            
            <label class="lbl-right" style="width:40px; margin-left:15px;">Fuel</label>
            <select id="cmbclosefuel" name="cmbclosefuel" style="width:100px;" value='<s:property value="cmbclosefuel"/>'>
                <option value="">-Select-</option><option value=0.000>Level 0/8</option><option value=0.125>Level 1/8</option>
                <option value=0.250>Level 2/8</option><option value=0.375>Level 3/8</option><option value=0.500>Level 4/8</option>
        ...
        <div class="field-row">
            <label class="lbl-right" style="width:60px;">Driver</label>
            <div class="input-search-container" style="width: 125px;">
                <input type="text" name="closedriver" id="closedriver" onKeyDown="getDriver(event,2);" value='<s:property value="closedriver"/>' readonly placeholder="Press F3" />
                <svg class="magnifier-icon" onclick="openDriverSearch(2);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            ...
            <label class="lbl-right" style="width:80px; margin-left:15px;">Staff</label>
            <div class="input-search-container" style="width: 140px;">
                <input type="text" name="closestaff" id="closestaff" value='<s:property value="closestaff"/>' onKeyDown="getStaff(event,2);" readonly placeholder="Press F3" />
                <svg class="magnifier-icon" onclick="openStaffSearch(2);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            ...
            <label class="lbl-right" style="width:60px; margin-left:15px;">Accidents</label>
            ...
            <label class="lbl-right" style="width:40px; margin-left:15px;">Fines</label>
            <input type="text" name="accfines" id="accfines" style="width:80px; text-align:right;" value='<s:property value="accfines"/>'/>
            
            <label class="lbl-right" style="width:40px; margin-left:15px;">User</label>
            <input type="text" id="closeuser" name="closeuser" style="width:100px; text-transform:uppercase;" value='<s:property value="closeuser"/>' readonly />
        ...
        <div class="field-row">
            ...
            <label class="lbl-right" style="width:60px; margin-left:15px;">Total KM</label>
            <input type="text" id="totalkm" name="totalkm" style="width:100px; text-align:right;" value='<s:property value="totalkm"/>' readonly />
            
            <input type="button" name="btnclose" id="btnclose" class="myButton" value="Close" onclick="closeMov();" style="margin-left: 15px;">
            <input type="button" name="btnclosesave" id="btnclosesave" class="myButton" value="Save" onclick="closeSave();" style="margin-left: 15px; display:none;">
        </div>
...
<div id="driverwindow"><div></div><div></div></div>
<div id="staffwindow"><div></div><div></div></div>
<div id="garagewindow"><div></div><div></div></div>
