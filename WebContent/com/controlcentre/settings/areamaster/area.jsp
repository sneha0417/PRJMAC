...
<body onLoad="getRegion();getCountry();getCity();funReadOnly();setValues();">
    ...
    <div class="modern-ui hidden-scrollbar">
        ...
        <form id="frmArea" action="saveArea" autocomplete="off">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">City Details</span>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Date</label>
                    <div style="width: 120px;">
                        <div id="date_area" name="date_area" value='<s:property value="date_area"/>'></div>
                    </div>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Region</label>
                    ...
                    <select name="country" id="country" onchange="getCity();" style="width:200px;"></select>
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">State / Province</label>
                    <select name="city" id="city" style="width:200px;"></select>
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">City</label>
                    <input type="text" name="area" id="area" value='<s:property value="area"/>' style="width:200px;">
                </div>
            </div>
            ...
            <div style="display:none;">
                ...
                <input type="text" id="city_id" name="city_id" value='<s:property value="city_id"/>'>
        ...
        <div class="middle-panel" style="margin-bottom:0;">
            <span class="middle-panel-title">City Records</span>
            <div id="jqxAreaSearch1" class="grid-container"></div>  
        </div>
