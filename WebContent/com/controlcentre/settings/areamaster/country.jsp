...
.hidden-scrollbar {
    /* Removed dynamic height (calc 100vh) to prevent reflow loops */
    padding-right: 5px;
}
...
<div id="mainBG" class="homeContent" data-type="background">
    ...
    <div class="modern-ui hidden-scrollbar">
        <form id="frmCountry" action="saveCountry" autocomplete="off">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <select name="region" id="region" style="width:200px;"></select>
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px;">Country</label>
                    <input type="text" name="country" id="country" value='<s:property value="country"/>' style="width:200px;">
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Country Code</label>
                    <input type="text" name="contry_code" id="contry_code" value='<s:property value="contry_code"/>' style="width:120px;">
                </div>
            </div>
        ...
        <div class="middle-panel" style="margin-bottom:0;">
            <span class="middle-panel-title">Country Records</span>
