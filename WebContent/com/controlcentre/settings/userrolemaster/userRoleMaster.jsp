        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel" style="margin-top: 20px;">
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtrolename" name="txtrolename" style="width:250px;" value='<s:property value="txtrolename"/>'/>
                    
                    <label class="lbl-right" style="width:80px;">Email</label>
                    <input type="email" id="txtemail" name="txtemail" placeholder="someone@example.com" style="flex:1; max-width: 400px;" value='<s:property value="txtemail"/>'/>
