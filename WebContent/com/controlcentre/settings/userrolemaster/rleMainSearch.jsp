...
/* Search Button - Light Blue Gradient (Matched to Image) */
.modern-ui .myButton {
    height: 28px;
    padding: 0 24px;
    /* Light blue gradient: darker top, lighter bottom */
    background: linear-gradient(to bottom, #86bcf6 0%, #d4e8fd 100%);
    color: #ffffff;
    border: 1px solid #9dc7f2; /* Subtle border to define edges */
    border-radius: 4px;
    cursor: pointer;
    font-size: 12px;
    font-weight: 700 !important; /* Bold text like the image */
    font-family: inherit;
    /* Very slight text shadow to ensure the white text is readable against the light blue */
...
.modern-ui .myButton:hover {
    background: linear-gradient(to bottom, #79b3f3 0%, #c5e0fd 100%);
}
