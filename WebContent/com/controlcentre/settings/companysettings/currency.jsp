    ...
    <form id="frmCurrency" action="saveActionCurrency" autocomplete="off">
        ...
        <div class="modern-ui">
            ...
            <div class="middle-panel" style="margin-top: 20px;">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Doc No</label>
                    <input type="text" id="docno" name="docno" style="width:150px;" value='<s:property value="docno"/>' readonly="readonly"/>
                </div>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtcodename" name="txtcodename" style="flex:1; max-width: 300px;" value='<s:property value="txtcodename"/>' placeholder="Currency Name" />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Country</label>
                    <input type="text" id="txtcountry" name="txtcountry" style="width:250px;" value='<s:property value="txtcountry"/>' />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Fraction</label>
                    ...
                    <input type="text" id="txtdecimal" name="txtdecimal" style="width:150px;" value='<s:property value="txtdecimal"/>' />
                </div>
            </div>
