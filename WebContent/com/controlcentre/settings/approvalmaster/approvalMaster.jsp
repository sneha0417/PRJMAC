...
.modern-ui .icon-btn:hover { background: #e2e8f0; }

/* Tabs container overrides */
.jqx-tabs-content-element { padding: 15px; background: #fff; }
...
<div id="mainBG" class="homeContent" data-type="background">
    ...
    <form id="frmApprovalMaster" action="saveApprovalMaster" method="post" autocomplete="off" > 
        ...
        <div class="modern-ui">
            ...
            <div id="main" class="middle-panel" style="margin-top: 20px;">
                <span class="middle-panel-title">Document Setup</span>
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Doc Type</label>
                    <input type="text" id="doctype" name="doctype" style="width:120px;" placeholder="Press F3 To Search" value='<s:property value="doctype"/>' required="required" onKeyDown="getUser(event);" readonly/>
                    ...
                    <input type="text" id="docno" name="docno" tabindex="-1" style="width:150px;" value='<s:property value="docno"/>'/>
                </div>
            </div>
            ...
            <div id="jqxTabs">
                ...
                <div id="level1">
                    <div id="lev1" class="field-row" style="margin-bottom: 20px; padding-bottom: 10px; border-bottom: 1px solid #eee;">
                        <input type="button" class="myButton" id="addUser" name="addUser" value="Add User" onclick="addUser1();" readonly >
                        
                        <div class="chk-wrapper" style="margin-left: 20px;">
                            <input type="checkbox" id="chckfinalmodify" name="chckfinalmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="margin:0; cursor:pointer;" />
                            <label for="chckfinalmodify" style="margin:0; cursor:pointer;">Modify</label>
                        </div>
                        
                        <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtfinal_minapproval" name="txtfinal_minapproval" style="width:100px;" value='<s:property value="txtfinal_minapproval"/>'/>
                    </div>
                    
                    <div id="users">
                        <div id="user1" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfinal_user1" name="txtfinal_user1" style="width:150px;" value='<s:property value="txtfinal_user1"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="final_btnSearch1" title="Search" onclick="funSearchBtn11(1,'level1')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="final_btnCancel1" title="Remove" onclick="funResetbtn1(1,'final')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="user2" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfinal_user2" name="txtfinal_user2" style="width:150px;" value='<s:property value="txtfinal_user2"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="final_btnSearch2" title="Search" onclick="funSearchBtn11(2,'level1')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="final_btnCancel2" title="Remove" onclick="funResetbtn1(2,'final')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="user3" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfinal_user3" name="txtfinal_user3" style="width:150px;" value='<s:property value="txtfinal_user3"/>'/>
                            <input type="hidden" name="txtfinal_userdoc3" id="txtfinal_userdoc3" value='<s:property value="txtfinal_userrole3"/>'> <input type="text" id="txtfinal_userfull3" name="txtfinal_userfull3" style="flex:1;" value='<s:property value="txtfinal_userfull3"/>'/>
                            
                            <button type="button" class="icon-btn" id="final_btnSearch3" title="Search" onclick="funSearchBtn11(3,'level1')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="final_btnCancel3" title="Remove" onclick="funResetbtn1(3,'final')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="user4" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfinal_user4" name="txtfinal_user4" style="width:150px;" value='<s:property value="txtfinal_user4"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="final_btnSearch4" title="Search" onclick="funSearchBtn11(4,'level1')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="final_btnCancel4" title="Remove" onclick="funResetbtn1(4,'final')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="user5" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfinal_user5" name="txtfinal_user5" style="width:150px;" value='<s:property value="txtfinal_user5"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="final_btnSearch5" title="Search" onclick="funSearchBtn11(5,'level1')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="final_btnCancel5" title="Remove" onclick="funResetbtn1(5,'final')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                    </div>
                ...
                <div id="level2">
                    <div id="lev2" class="field-row" style="margin-bottom: 20px; padding-bottom: 10px; border-bottom: 1px solid #eee;">
                        <input type="button" class="myButton" id="addUsr" value="Add User" name="addUsr" onclick="addUsr1();">
                        
                        <div class="chk-wrapper" style="margin-left: 20px;">
                            <input type="checkbox" id="chcksecondmodify" name="chcksecondmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="margin:0; cursor:pointer;" />
                            <label for="chcksecondmodify" style="margin:0; cursor:pointer;">Modify</label>
                        </div>
                        
                        <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtsecond_minapproval" name="txtsecond_minapproval" style="width:100px;" value='<s:property value="txtsecond_minapproval"/>'/>
                    </div>
                    
                    <div id="usrs">
                        <div id="usr1" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtsecond_user1" name="txtsecond_user1" style="width:150px;" value='<s:property value="txtsecond_user1"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="second_btnSearch1" title="Search" onclick="funSearchBtn11(1,'level2')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="second_btnCancel1" title="Remove" onclick="funResetbtn1(1,'second')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="usr2" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtsecond_user2" name="txtsecond_user2" style="width:150px;" value='<s:property value="txtsecond_user2"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="second_btnSearch2" title="Search" onclick="funSearchBtn11(2,'level2')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="second_btnCancel2" title="Remove" onclick="funResetbtn1(2,'second')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="usr3" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtsecond_user3" name="txtsecond_user3" style="width:150px;" value='<s:property value="txtsecond_user3"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="second_btnSearch3" title="Search" onclick="funSearchBtn11(3,'level2')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="second_btnCancel3" title="Remove" onclick="funResetbtn1(3,'second')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="usr4" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtsecond_user4" name="txtsecond_user4" style="width:150px;" value='<s:property value="txtsecond_user4"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="second_btnSearch4" title="Search" onclick="funSearchBtn11(4,'level2')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="second_btnCancel4" title="Remove" onclick="funResetbtn1(4,'second')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="usr5" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtsecond_user5" name="txtsecond_user5" style="width:150px;" value='<s:property value="txtsecond_user5"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="second_btnSearch5" title="Search" onclick="funSearchBtn11(5,'level2')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="second_btnCancel5" title="Remove" onclick="funResetbtn1(5,'second')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                    </div>
                ...
                <div id="level3">
                    <div id="lev3" class="field-row" style="margin-bottom: 20px; padding-bottom: 10px; border-bottom: 1px solid #eee;">
                        <input type="button" class="myButton" id="addUsers" value="Add User" name="addUsers" onclick="addUsers1();">
                        
                        <div class="chk-wrapper" style="margin-left: 20px;">
                            <input type="checkbox" id="chckfirstmodify" name="chckfirstmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="margin:0; cursor:pointer;" />
                            <label for="chckfirstmodify" style="margin:0; cursor:pointer;">Modify</label>
                        </div>
                        
                        <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtfirst_minapproval" name="txtfirst_minapproval" style="width:100px;" value='<s:property value="txtfirst_minapproval"/>'/>
                    </div>
                    
                    <div id="new_users">
                        <div id="new_user1" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfirst_user1" name="txtfirst_user1" style="width:150px;" value='<s:property value="txtfirst_user1"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="first_btnSearch1" title="Search" onclick="funSearchBtn11(1,'level3')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="first_btnCancel1" title="Remove" onclick="funResetbtn1(1,'first')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="new_user2" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfirst_user2" name="txtfirst_user2" style="width:150px;" value='<s:property value="txtfirst_user2"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="first_btnSearch2" title="Search" onclick="funSearchBtn11(2,'level3')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="first_btnCancel2" title="Remove" onclick="funResetbtn1(2,'first')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="new_user3" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfirst_user3" name="txtfirst_user3" style="width:150px;" value='<s:property value="txtfirst_user3"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="first_btnSearch3" title="Search" onclick="funSearchBtn11(3,'level3')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="first_btnCancel3" title="Remove" onclick="funResetbtn1(3,'first')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="new_user4" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfirst_user4" name="txtfirst_user4" style="width:150px;" value='<s:property value="txtfirst_user4"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="first_btnSearch4" title="Search" onclick="funSearchBtn11(4,'level3')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="first_btnCancel4" title="Remove" onclick="funResetbtn1(4,'first')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                        
                        <div id="new_user5" class="field-row" style="display:none;">
                            <label class="lbl-right" style="width:80px;">User</label>
                            <input type="text" id="txtfirst_user5" name="txtfirst_user5" style="width:150px;" value='<s:property value="txtfirst_user5"/>'/>
                            ...
                            <button type="button" class="icon-btn" id="first_btnSearch5" title="Search" onclick="funSearchBtn11(5,'level3')">
                                <img alt="search" src="../../../../icons/search_new.png">
                            </button>
                            <button type="button" class="icon-btn" id="first_btnCancel5" title="Remove" onclick="funResetbtn1(5,'first')">
                                <img alt="Remove" src="../../../../icons/cancel_new.png">
                            </button>
                        </div>
                    </div>
