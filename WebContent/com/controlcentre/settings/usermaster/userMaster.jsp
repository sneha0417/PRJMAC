    ...
    <form id="frmUserMaster" action="saveUserMaster" autocomplete="off">
        ...
        <div class="modern-ui">
            ...
            <div class="middle-panel" style="margin-top: 20px;">
                <span class="middle-panel-title">User Information</span>
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:100px;">User Name</label>
                    <input type="text" id="txtusername" name="txtusername" placeholder="Enter user Name" style="flex:1; max-width: 400px;" value='<s:property value="txtusername"/>' onblur="checkUsername()"/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Role</label>
                    <input type="text" id="txtbrole" name="txtbrole" style="width:150px;" placeholder="Press F3 to Search" value='<s:property value="txtbrole"/>' onkeydown="getURole(event);" />
                    <input type="hidden" id="txtroleid" name="txtroleid" value='<s:property value="txtroleid"/>'/>
                    
                    <label class="lbl-right" style="width:100px;">Language</label>
                    <select id="cmblanguage" name="cmblanguage" style="width:150px;" value='<s:property value="cmblanguage"/>'></select>
                    <input type="hidden" id="hidcmblanguage" name="hidcmblanguage" value='<s:property value="hidcmblanguage"/>'/>
                    
                    <label class="lbl-right" style="width:100px;">Permission</label>
                    <select id="cmpermission" name="cmpermission" style="width:150px;" value='<s:property value="cmpermission"/>' onchange="fungriddis()">    
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:100px;">Confirm</label>
                    <input type="password" id="txtpasswordconfirm" name="txtpasswordconfirm" style="width:150px;" placeholder="Confirm Password" value='<s:property value="txtpasswordconfirm"/>'/>
                    
                    <span id="message" style="font-weight: bold; margin-left: 10px; font-size: 11px;"></span>
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Email Configuration</span>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Email</label>
                    <input type="email" id="txtusermail" name="txtusermail" style="flex:1; max-width: 400px;" placeholder="someone@example.com" value='<s:property value="txtusermail"/>' />
                    
                    <label class="lbl-right" style="width:100px;">Email Password</label>
                    <input type="password" id="txtmailpswd" name="txtmailpswd" style="width:150px;" placeholder="Email Password" value='<s:property value="txtmailpswd"/>' />
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Email Host</label>
                    <input type="text" id="txtmailhost" name="txtmailhost" style="flex:1; max-width: 250px;" placeholder="Email Host" value='<s:property value="txtmailhost"/>' />
                    
                    <label class="lbl-right" style="width:80px;">Port</label>
                    <input type="text" id="txtmailport" name="txtmailport" style="width:100px;" placeholder="Port" value='<s:property value="txtmailport"/>' />
                    
                    <label class="lbl-right" style="width:80px;">Signature</label>
                    <input type="text" id="txtmailsign" name="txtmailsign" style="flex:1; max-width: 200px;" placeholder="Email Signature" value='<s:property value="txtmailsign"/>' />
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Branch Assignments</span>
                <div id="userMasterDiv" class="grid-container" align="center">
