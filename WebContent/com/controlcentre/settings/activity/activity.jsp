...
<div id="mainBG" class="homeContent" data-type="background">
    <div class="modern-ui hidden-scrollbar">
        ...
        <form id="frmActivity" action="saveActivity" method="get" autocomplete="off">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="text" name="activity" id="activity" value='<s:property value="activity"/>' style="width: 250px;">
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Activity Code</label>
                    <input type="text" name="activity_code" id="activity_code" value='<s:property value="activity_code"/>' style="width: 120px;">
                </div>
            </div>
        ...
        <div class="middle-panel" style="margin-bottom:0;">
            <span class="middle-panel-title">Activity Records</span>
