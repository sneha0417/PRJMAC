...
<style>
/* Master UI - Scoped strictly to avoid breaking enterprise layouts */
.modern-ui {
...
/* Disabled Button State - Restored */
...
#btnPrint {
    ...
    opacity: 0.5 !important;         /* Makes it look greyed-out/disabled */
        ...
        <form id="frmVehicle" action="saveVehicle" method="post" autocomplete="off">
            ...
            <div class="modern-ui">
                <div class="middle-panel" style="margin-top: 5px;">
                    ...
                    <div class="field-row">
                        <label class="lbl-right" style="width:70px;">Fleet No</label>
                        <input type="text" name="fleetno" id="fleetno" readonly tabindex="-1" style="width: 80px;" value='<s:property value="fleetno"/>'> 
                        <input type="text" name="fleetname" id="fleetname" readonly tabindex="-1" style="width: 200px;" value='<s:property value="fleetname"/>'>
                        
                        <label class="lbl-right" style="width:70px; margin-left:auto;">Date</label>
                    ...
                    <div class="field-row">
                        <label class="lbl-right" style="width:70px;">Authority</label>
                        <select name="cmbauthority" id="cmbauthority" value='<s:property value="cmbauthority"/>' style="width:130px;" onchange="getPlateCode(this.value);">
                            <option value="">--Select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:70px;">Plate Code</label>
                        <select name="cmbplate" id="cmbplate" value='<s:property value="cmbplate"/>' style="width:130px;">
                            <option>--select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:60px;">Reg No</label>
                        <input type="text" name="regno" id="regno" style="width:130px;" value='<s:property value="regno"/>' autocomplete="off" onblur="checkRegNo();">
                        
                        <label class="lbl-right" style="width:50px;">Group</label>
                        <select name="cmbgroup" id="cmbgroup" value='<s:property value="cmbgroup"/>' style="width:130px;" onchange="getLevel(this.value);">
                            <option>--Select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:50px;">Level</label>
                        <input type="text" name="group_name" id="group_name" value='<s:property value="group_name"/>' tabindex="-1" style="width:130px;">
                    </div>

                    <div class="field-row" style="margin-bottom: 0;">
                        <label class="lbl-right" style="width:70px;">Brand</label>
                        <select name="cmbbrand" id="cmbbrand" value='<s:property value="cmbbrand"/>' style="width:130px;" onchange="getModel(this.value);">
                            <option>--Select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:70px;">Model</label>
                        <select name="cmbmodel" id="cmbmodel" value='<s:property value="cmbmodel"/>' style="width:130px;" onchange="getFleetName();">
                            <option>--Select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:60px;">YoM</label>
                        <select name="cmbyom" id="cmbyom" value='<s:property value="cmbyom"/>' style="width:130px;">
                            <option>--Select--</option>
                        </select>
                        
                        <label class="lbl-right" style="width:70px;">Salik Tag</label>
                        <input type="text" id="salik_tag" name="salik_tag" value='<s:property value="salik_tag"/>' style="width:130px;" />
                        
                        <label class="lbl-right" style="width:50px;">TC No</label>
                        <input type="text" id="tcno" name="tcno" value='<s:property value="tcno"/>' style="width:130px;" />
                    </div>
                </div>
                ...
                <div id="content">
                    ...
                    <div id="tab1">
                        <div style="display: flex; gap: 15px; align-items: flex-start;">
                            ...
                            <div class="middle-panel" style="flex: 1; margin: 0;">
                                <span class="middle-panel-title">Info</span>
                                
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Registered Date</label><div style="flex:1;"><div id='jqxFinRegDate' name='jqxFinRegDate' value='<s:property value="jqxFinRegDate"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Reg. Expiry</label><div style="flex:1;"><div id='jqxOtherRegExp' name='jqxOtherRegExp' value='<s:property value="jqxOtherRegExp"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Insurance Expiry</label><div style="flex:1;"><div id='jqxOtherInsExp' name='jqxOtherInsExp' value='<s:property value="jqxOtherInsExp"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Purchase Cost</label><input type="text" name="purchase_cost" id="purchase_cost" value='<s:property value="purchase_cost"/>' style="text-align:right; flex:1;" onblur="getTotal();" required/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Additions</label><input type="text" id="additions" name="additions" value='<s:property value="additions"/>' style="text-align:right; flex:1;" onblur="getTotal();"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Total</label><input type="text" id="total" name="total" value='<s:property value="total"/>' style="text-align:right; flex:1;" readonly/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Depr %</label><input type="text" id="depr_perc" name="depr_perc" value='<s:property value="depr_perc"/>' style="text-align:right; flex:1;" onblur="depr_percent(this.value);"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Accu. Dep.</label><input type="text" id="accu_dep" name="accu_dep" value='<s:property value="accu_dep"/>' style="text-align:right; flex:1;" /></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">CostTran No</label><input type="text" id="tran_no" readonly name="tran_no" value='<s:property value="tran_no"/>' tabindex="-1" style="flex:1;"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Insur Membership</label><input type="text" name="insurmember" id="insurmember" value='<s:property value="insurmember"/>' style="flex:1;"/></div>
                                <div class="field-row" style="margin-bottom:0;"><label class="lbl-right" style="width:110px;">Tracking ID</label><input type="text" name="trackid" id="trackid" value='<s:property value="trackid"/>' style="flex:1;"/></div>
                            </div>

                            <div class="middle-panel" style="flex: 1; margin: 0;">
                                <span class="middle-panel-title">Other Info</span>
                                
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Dealer</label><input type="text" name="dealer" id="dealer" value='<s:property value="dealer"/>' onDblClick="funSearchdblclick();" onKeyDown="getDealer(event);" placeholder="Press F3 to Search" style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">LPO No</label><input type="text" id="lpo_no" name="lpo_no" value='<s:property value="lpo_no"/>' style="flex:1;"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Purchase Invoice</label><input type="text" id="purchase_invoice" name="purchase_invoice" value='<s:property value="purchase_invoice"/>' style="flex:1;"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Purchase Date</label><div style="flex:1;"><div id='jqxPurchaseDate' name='jqxPurchaseDate' value='<s:property value="jqxPurchaseDate"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Financer</label><input type="text" name="financier" id="financier" value='<s:property value="financier"/>' ondblclick="funFinSearchdblclick();" onkeydown="getFin(event);" placeholder="Press F3 to Search" style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Release Date</label><div style="flex:1;"><div id='jqxFinRelDate' name='jqxFinRelDate' value='<s:property value="jqxFinRelDate"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Insurance Type</label><select name="cmbinsurance_type" id="cmbinsurance_type" value='<s:property value="cmbinsurance_type"/>' style="flex:1;"><option value="">--Select--</option><option value="Comprehensive">Comprehensive</option><option value="3rdParty">3rd Party</option></select></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Insurance Comp</label><input type="text" id="insurance_comp" name="insurance_comp" placeholder="Press F3 to Search" value='<s:property value="insurance_comp"/>' ondblclick="funInsurSearchdblclick();" onkeydown="getInsurance(event);" style="flex:1;"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">Policy No</label><input type="text" id="policy_no" name="policy_no" value='<s:property value="policy_no"/>' onblur="getservtab();" style="flex:1;"/></div>
                                <div class="field-row"><label class="lbl-right" style="width:110px;">File No</label><input type="text" name="fileno" id="fileno" value='<s:property value="fileno"/>' style="flex:1;"/></div>
                                <div class="field-row" style="margin-bottom:0;"><label class="lbl-right" style="width:110px;">Mortgaged To</label><input type="text" name="mortgaged" id="mortgaged" value='<s:property value="mortgaged"/>' placeholder="Press F3 to Search" readonly onkeydown="getMortgaged(event);" style="flex:1;"/></div>
                            </div>

                            <div class="middle-panel" id="releaseid" style="flex: 1; margin: 0;">
                                <span class="middle-panel-title">Fleet Release Info</span>
                                
                                <div class="field-row" style="justify-content: center; margin-bottom: 15px;">
                                    <input type="button" name="releasesave" id="releasesave" class="myButton" value="Save" onClick="funRelease();" style="margin-right: 5px;">
                                    <input type="button" name="btnrelease" id="btnrelease" class="myButton" value="Release" onClick="funEnable();">
                                </div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Fleet No</label><input type="text" name="releasefleet" id="releasefleet" value='<s:property value="releasefleet"/>' style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Branch</label><select name="cmbrlsbranch" id="cmbrlsbranch" value='<s:property value="cmbrlsbranch"/>' onChange="getLocation(this.value);" style="flex:1;"><option value="">--Select--</option></select></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Location</label><select name="cmbrlsloc" id="cmbrlsloc" value='<s:property value="cmbrlsloc"/>' style="flex:1;"><option value="">--Select--</option></select></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Rental Status</label><select name="cmbrentalstatus" id="cmbrentalstatus" value='<s:property value="cmbrentalstatus"/>' style="flex:1;"><option value="R">Rental</option><option value="L">Lease</option><option value="LM">Limousine</option><option value="A">All</option></select></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Date</label><div style="flex:1;"><div id="releasedate" name="releasedate" value='<s:property value="releasedate"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Time</label><div style="flex:1;"><div id="releasetime" name="releasetime" value='<s:property value="releasetime"/>'></div></div></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">KM</label><input type="text" name="releasekm" id="releasekm" value='<s:property value="releasekm"/>' tabindex="-1" readonly style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Fuel</label><input type="text" name="releasefuel" id="releasefuel" value='<s:property value="releasefuel"/>' tabindex="-1" readonly style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Op. Status</label><input type="text" name="opstatus" id="opstatus" value='IN' tabindex="-1" disabled="true" style="flex:1;"></div>
                                <div class="field-row"><label class="lbl-right" style="width:80px;">Ast status</label><input type="text" name="aststatus" id="aststatus" value='<s:property value="aststatus"/>' tabindex="-1" style="flex:1;"></div>
                    ...
                    <div id="tab2">
                        <div class="middle-panel" style="margin-top:0;">
                            ...
                            <div class="field-row" style="margin-bottom:0;">
                                <label class="lbl-right" style="width:80px;">Engine No</label><input type="text" id="engine_no" name="engine_no" value='<s:property value="engine_no"/>' style="text-transform:uppercase; width:120px;"/>
                                <label class="lbl-right" style="width:80px;">Chasis No</label><input type="text" id="chasis_no" name="chasis_no" value='<s:property value="chasis_no"/>' style="text-transform:uppercase; width:120px;"/>
                                <label class="lbl-right" style="width:50px;">VIN</label><input type="text" name="vin" id="vin" value='<s:property value="vin"/>' style="width:120px;" />
                                <label class="lbl-right" style="width:80px;">Fuel Type</label><select name="cmbfueltype" id="cmbfueltype" style="width:100px;"><option value="">--Select--</option><option value="P">Petrol</option><option value="D">Diesel</option></select>
                                <label class="lbl-right" style="width:120px;">Fuel Tank Capacity</label><input type="text" name="fuelcapacity" id="fuelcapacity" value='<s:property value="fuelcapacity"/>' style="width:80px;"/>
                                <label class="lbl-right" style="width:50px;">Color</label><select name="cmbveh_color" id="cmbveh_color" value='<s:property value="cmbveh_color"/>' style="flex:1;"><option>--Select--</option></select> 
                            </div>
                        </div>
                        ...
                        <div class="middle-panel">
                            ...
                            <div class="field-row" style="margin-bottom:0;">
                                <label class="lbl-right" style="width:110px;">Warranty Period</label><input type="text" id="warranty_period" name="warranty_period" value='<s:property value="warranty_period"/>' onblur="getWarrantyDate(this.value);" style="width:120px;"/>
                                <label class="lbl-right" style="width:80px;">From Date</label><div style="width:120px;"><div id='jqxWrntyFrmDate' name='jqxWrntyFrmDate' value='<s:property value="jqxWrntyFrmDate"/>'></div></div>
                                <label class="lbl-right" style="width:80px;">To Date</label><div style="width:120px;"><div id='jqxWrntyToDate' name='jqxWrntyToDate' value='<s:property value="jqxWrntyToDate"/>'></div></div>
                                <label class="lbl-right" style="width:90px;">Warranty KM</label><input type="text" name="warranty_km" id="warranty_km" value='<s:property value="warranty_km"/>' style="text-align:right; flex:1;"/>
                            </div>
                        </div>
                        ...
                        <div class="middle-panel">
                            ...
                            <div class="field-row" style="margin-bottom:0;">
                                <label class="lbl-right" style="width:140px;">Service Duration (KM)</label><input type="text" id="service_km" name="service_km" value='<s:property value="service_km"/>' style="text-align:right; width:120px;"/>
                                <label class="lbl-right" style="width:110px;">Last Srvc. Date</label><div style="width:120px;"><div id='jqxLstSrvcDate' name='jqxLstSrvcDate' value='<s:property value="jqxLstSrvcDate"/>'></div></div>
                                <label class="lbl-right" id="lbllastsrvkm" style="width:110px;">Last Service KM</label><input type="text" id="last_srvc_km" name="last_srvc_km" value='<s:property value="last_srvc_km"/>' style="text-align:right; flex:1;"/>
                            </div>
                        </div>
                        ...
                        <div class="middle-panel">
                            ...
                            <div class="field-row" style="margin-bottom:0;">
                                <label class="lbl-right" style="width:80px;">Current KM</label><input type="text" id="current_km" name="current_km" value='<s:property value="current_km"/>' style="text-align:right; width:120px;"/>
                                <label class="lbl-right" style="width:50px;">Fuel</label><select name="cmbfuel" id="cmbfuel" value='<s:property value="cmbfuel"/>' style="width:120px;"><option value=0.000>Level 0/8</option><option value=0.125 selected>Level 1/8</option><option value=0.250>Level 2/8</option><option value=0.375>Level 3/8</option><option value=0.500>Level 4/8</option><option value=0.625>Level 5/8</option><option value=0.750>Level 6/8</option><option value=0.875>Level 7/8</option><option value=1.000>Level 8/8</option></select>
                                <label class="lbl-right" style="width:80px;">Avail. Br.</label><select name="cmbavail_br1" id="cmbavail_br1" value='<s:property value="cmbavail_br1"/>' style="width:150px;"></select>
                                <label class="lbl-right" style="width:110px;">Calibration Km</label><input type="text" name="calibrationkm" id="calibrationkm" value='<s:property value="calibrationkm"/>' style="text-align:right; flex:1;" onblur="getspectab();">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab3">
                        <table width="100%">
                            <tr>
                                <td>
                                    <div id="specdiv"><center><jsp:include page="specificationGrid.jsp"></jsp:include></center></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <input type="text" id="no_installments" name="no_installments" value='<s:property value="no_installments"/>' hidden="true"/>
                    ...
                    <select name="purchase" id="purchase" hidden="true" value='<s:property value="purchase"/>'><option>--Select--</option><option value="Cash" selected>Cash</option><option value="Credit">Credit</option></select>
                    ...
                    <select name="branded" id="branded" value='<s:property value="branded"/>' hidden="true"><option value="Y" selected>Y</option><option value="N">N</option></select>
