...
<script type="text/javascript">
    $(document).ready(function () {          
        ...
        $("#dealerdate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });  
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <div class="input-search-container" style="width: 250px;">
                        <input type="text" name="txtaccname" id="txtaccname" value='<s:property value="txtaccname"/>' placeholder="Press F3 to Search" ondblclick="funSearchdblclick();" onkeydown="getAcc(event);" readonly required />
                    ...
                    <input type="text" name="dealername" id="dealername" value='<s:property value="dealername"/>' style="width: 200px;">
                </div>
            </div>
