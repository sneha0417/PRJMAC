...
<script type="text/javascript">
    $(document).ready(function () {          
        ...
        $("#insurdate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"}); 
    ...
    $(function(){
        $('#frmInsurance').validate({
            rules: {
                insurcompany: { required:true, maxlength:40 }, 
                txtaccname: { required:true }
            },
            messages: {
                insurcompany: { required:" *", maxlength:"max 40 chars" },
                txtaccname: { required:" *" }
            }
        });
    });
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Company</label>
                    <input type="text" name="insurcompany" id="insurcompany" value='<s:property value="insurcompany"/>' style="width: 200px;">
                </div>
            </div>
