            ...
            $("#jqxBrandSearch1").jqxGrid(
                    {
                        ...
                        columns: [
        					...
        					{ text: 'BRAND',columntype: 'textbox', filtertype: 'input', datafield: 'BRAND_NAME', width: '60%' },
        					{ text: 'DATE',columntype: 'textbox', filtertype: 'input', datafield: 'DATE', width: '25%',cellsformat:'dd.MM.yyyy' }
        	              ]
                    });
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="text" name="brand" id="brand" value='<s:property value="brand"/>' style="width:300px;" />
            </div>
        </div>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                <div id="jqxBrandSearch1" class="grid-container"></div>  
            </div>
        </div>
