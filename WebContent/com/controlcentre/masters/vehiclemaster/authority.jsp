          ...
          $("#jqxAuthoritySearch1").jqxGrid(
                  {
                      ...
                      columns: [
                        ...
                        { text: 'Authority',columntype: 'textbox', filtertype: 'input', datafield: 'authname', width: '45%' },
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="text" name="auth" id="auth" value='<s:property value="auth"/>' style="width:150px;" />
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Authority Search</span>
            <div class="field-row">
                <div id="jqxAuthoritySearch1" class="grid-container"></div>  
            </div>
        </div>
