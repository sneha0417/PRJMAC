...
<script type="text/javascript">
    $(document).ready(function () {  
        ...
        $("#findate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });
    ...
    $(function(){
        $('#frmFinancier').validate({
            rules: {
                finid: { required:true, maxlength:8 }, 
                txtaccname: { required:true },
                finname: { maxlength:40 }
            },
            messages: {
                finid: { required:" *", maxlength:"max 8 chars" },
                txtaccname: { required:" *" },
                finname: { maxlength:"max 40 chars" }
            }
        });
    });
    ...
    <form id="frmFinancier" action="saveActionFinancier" autocomplete="off">
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Financier Code</label>
                    <input type="text" name="finid" id="finid" value='<s:property value="finid"/>' style="width:120px;">
                    
                    <label class="lbl-right" style="width:100px; margin-left:auto;">Name</label>
                    <input type="text" name="finname" id="finname" value='<s:property value="finname"/>' style="width: 250px;">
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">Account</label>
                    <div class="input-search-container" style="width: 250px;">
                        <input type="text" name="txtaccname" id="txtaccname" value='<s:property value="txtaccname"/>' placeholder="Press F3 to Search" ondblclick="funSearchdblclick();" onkeydown="getAcc(event);" required />
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Records</span>
