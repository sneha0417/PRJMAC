...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#groupdate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="text" name="group" id="group" value='<s:property value="group"/>' style="width:125px;" required="required">
            ...
            <div style="display:none;">
                <input type="hidden" id="level" name="level" value='<s:property value="level"/>'/>
                <input type="hidden" id="utype" name="utype" value='<s:property value="utype"/>'/>
