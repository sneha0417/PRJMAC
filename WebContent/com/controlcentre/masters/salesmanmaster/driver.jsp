...
<div class="modern-ui">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <div style="width:160px;">
                ...
                <div id="driverdate"
                     name="driverdate"
                     value='<s:property value="driverdate"/>'></div>
        ...
        <div class="field-row">
            ...
            <div style="display:flex; align-items:center; gap:6px; margin-left:15px;">
                ...
                <label class="lbl-right">External</label>
    ...
    <div class="middle-panel">
        ...
        <span class="middle-panel-title">Driver Information</span>
    ...
    <div style="display:none;">
        ...
        <input type="hidden"
               name="hiddriverdate"
               id="hiddriverdate"
               value='<s:property value="hiddriverdate"/>'>

        <input type="hidden"
               name="hidlicenseexpiry"
               id="hidlicenseexpiry"
               value='<s:property value="hidlicenseexpiry"/>'>
