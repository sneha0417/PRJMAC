				...
				var rowg=$('#rowindexg').val();
			     //alert("rowg1=========="+rowg);
			      if(document.getElementById("rowindexg").value!="" && !(document.getElementById("rowindexg").value==null) && !(document.getElementById("rowindexg").value=="undefiend")){
			    	  $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "proid", document.getElementById("jqxInput").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "proname", document.getElementById("jqxInput1").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "brandname", document.getElementById("brand").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowg, "unitdocno", document.getElementById("unit").value);
					     if(document.getElementById("unit").value>0){
					     	$('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "unit", $("#unit option:selected").text());
					     }
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "psrno", document.getElementById("temppsrno").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "prodoc", document.getElementById("temppsrno").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "specid", document.getElementById("tempspecid").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "productid" ,document.getElementById("jqxInput").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "productname", document.getElementById("jqxInput1").value);
					     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowg, "qty", document.getElementById("quantity").value);
...
//		 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "collqty", document.getElementById("collqty").value);
			     ...
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "proid", document.getElementById("jqxInput").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "proname", document.getElementById("jqxInput1").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "brandname", document.getElementById("brand").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "unitdocno", document.getElementById("unit").value);
			     if(document.getElementById("unit").value>0){
			     	$('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "unit", $("#unit option:selected").text());
			     }
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "psrno", document.getElementById("temppsrno").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "prodoc", document.getElementById("temppsrno").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "specid", document.getElementById("tempspecid").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowlength-1, "productid" ,document.getElementById("jqxInput").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "productname", document.getElementById("jqxInput1").value);
			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "qty", document.getElementById("quantity").value);
// 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "foc", document.getElementById("focs").value);
// 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowlength-1, "collqty", document.getElementById("collqty").value);
			     $("#jqxDeliveryNote").jqxGrid('addrow', null, {});
			      }
