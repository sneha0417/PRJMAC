...
function loadSearch() {
    ...
    var Cl_clientsale = document.getElementById("Cl_clientsale").value || "";
...
function getdata(clname, mob, Cl_clientsale) {
    ...
    $("#refreshdiv1").load('searchClient.jsp?clname=' + encodeURIComponent(clname) + 
                           '&mob=' + encodeURIComponent(mob) + 
                           '&Cl_clientsale=' + encodeURIComponent(Cl_clientsale));
}
</script>
</head>
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <colgroup>
                <col width="12%" /> <col width="58%" /> 
                <col width="10%" /> <col width="20%" />
            </colgroup>
            
            <tr>
                <td class="lbl-right">Name</td>
                <td><input type="text" name="Cl_name" id="Cl_name" value='<s:property value="Cl_name"/>'></td>
                
                <td class="lbl-right">MOB</td>
                <td><input type="text" name="Cl_mob" id="Cl_mob" value='<s:property value="Cl_mob"/>'></td>
            </tr>
            
            <tr>
                <td class="lbl-right">Sales Person</td>
                <td><input type="text" name="Cl_clientsale" id="Cl_clientsale" value='<s:property value="Cl_clientsale"/>'></td>
                
                <td colspan="2" align="right" valign="middle" style="padding-top: 10px;">
