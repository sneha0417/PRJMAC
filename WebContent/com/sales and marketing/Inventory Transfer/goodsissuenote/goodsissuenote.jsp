    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="text" name="site" id="site" style="width:150px;" value='<s:property value="site"/>' >
                
                <label class="lbl-right" style="width:80px;">Location</label>
                <div class="input-search-container" style="width: 256px;">
        ...
        <div id="psearch" class="middle-panel">
            ...
            <div class="field-row" style="align-items: flex-end; margin-bottom:0;">
                ...
                <div style="flex:1; min-width: 80px;">
                    ...
                    <input type="text" id="quantity" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" onchange="calculatedata(this.id);" style="text-align: left; width: 100%;" />
                </div>
