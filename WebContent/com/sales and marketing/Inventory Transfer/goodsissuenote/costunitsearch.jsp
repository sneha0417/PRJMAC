...
String docnoss=request.getParameter("docno")==null?"0":request.getParameter("docno");%>
	...
	$(document).ready(function () { 
  	...
  	function loadSearchss() {
 		...
 		var site=document.getElementById("sitenames").value;
 		 //alert("headacccode"+headacccode);
      
	 
		getdatas(docnoss,refnames,docno,site);
 

	}
	function getdatas(docnoss,refnames,docno,site){
		 var search="yes";
		 $("#refsearch").load('subcostunitsearch.jsp?docnoss='+docnoss+'&refnames='+refnames+'&docno='+docno+'&search='+search+'&site='+site);
