...
#frminventoryissue table {
    width: 100%;
    border-collapse: separate;
    border-spacing: 0 8px; 
}

#frminventoryissue td {
    padding: 0 5px;
...
#frminventoryissue td[align="right"],
#frminventoryissue div[align="right"] {
    text-align: right; 
    color: #444;
    font-size: 12px; 
    font-weight: bold;
    ...
    <fieldset>
      ...
      <table width="100%">
        <tr>
          ...
          <td width="21%">
            <select id="cmbreftype" name="cmbreftype" style="width:100%;" onchange="set()" value='<s:property value="cmbreftype"/>'>
          ...
          <td width="21%">
            <input type="text" id="txtfrmbranch" name="txtfrmbranch" placeholder="Press F3 to Search" style="width:100%;" value='<s:property value="txtfrmbranch"/>'/>
          </td>
          
          <td width="12%" align="right">Location</td>
          <td width="21%">
    ...
    <fieldset>
      ...
      <table width="100%">
        <tr>
          ...
          <td width="20%">
            <input type="text" id="txttobranch" name="txttobranch" placeholder="Press F3 to Search" onkeydown="getBranch(event,2);" style="width:100%;" value='<s:property value="txttobranch"/>'/>
          </td>
          
          <td width="14%" align="right">Location</td>
          <td width="20%">
            <input type="text" id="txttolocation" name="txttolocation" placeholder="Press F3 to Search" onkeydown="getLocation(event,2);" style="width:100%;" value='<s:property value="txttolocation"/>'/>
          </td>
