  ...
  $('#serviecGrid').on('rowdoubleclick', function (event) {
           ...
           function valchange(rowBoundIndex,datafield)
           {
        	   ...
        	   if(datafield=='unitprice'){
        		   var uprice=$('#serviecGrid').jqxGrid('getcellvalue', rowBoundIndex, "unitprice");
          		 var sprice=document.getElementById("hidsellprice").value;
        			...
        			if(parseFloat(uprice)<parseFloat(sprice)){
        				...
        				$('#serviecGrid').jqxGrid('setcellvalue', rowBoundIndex, "unitprice",0);
                  ...
                  if ($.trim($(args).text()) == "Edit Selected Row") {
                     ...
                     //	alert("==rowlength=="+rowlength);
                       	if(parseInt(rowlength)==0){
                               ...
                               document.getElementById("prddiscount").value=0; 
                       		...
                       		for(var i=0;i<rowlength;i++){
                       			var totalchk=$('#serviecGrid').jqxGrid('getcellvalue', i, "total");
                       			var discountchk=$('#serviecGrid').jqxGrid('getcellvalue', i, "discount");
                       			var taxamountchk=$('#serviecGrid').jqxGrid('getcellvalue', i, "taxamount");
                       			var taxpersumchk=$('#serviecGrid').jqxGrid('getcellvalue', i, "taxperamt");
                       		//	alert("totalchk=="+totalchk+"==discountchk=="+discountchk+"==taxamountchk=="+taxamountchk);
                       		...
                       		funRoundAmt4(discountsum,"prddiscount");
                       		funRoundAmt4(totalsum,"productTotal");
                       		funRoundAmt4(taxamountsum,"netTotaldown");
...
//    		  }
           		...
           		if(datafield=="qty")
                	...
                	if(document.getElementById("reftype").value=="GRN" || document.getElementById("reftype").value=="PO")
           			...
           			if(document.getElementById("hidload").value=="" || document.getElementById("hidload").value==null || document.getElementById("hidload").value=="undefiend" || document.getElementById("hidload").value=="0"){
           				//alert("====in load=====");
