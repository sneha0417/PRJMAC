...
/* Validation Error override from legacy */
.modern-ui label.error { color: red; font-weight: bold; font-size: 11px; }
...
<body onLoad="setValues();chkcostcode();getitemtype();getDefaultLocation();getCashConfig();getCurrencyIds();">
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <button type="button" title="Show data" class="myButton" id="FixedDiv" style="position:fixed;z-index:1000;right:130px;top:90px; height: 36px !important; padding: 0 5px;" value='<s:property value="FixedDiv" /> '>
         <img alt="Show data" src="<%=contextPath%>/icons/reportpurchase.png" width="30" height="30" > 
    </button>
    ...
    <div style="position:fixed;z-index:1000;right:270px;top:25px;font-weight:bold;color:red;font-size: 12px; display: flex; align-items: center; gap: 5px;"> 
        <label>Order Value:</label> 
        <input type="text" id="orderValuefinal" name="orderValuefinal" style="width:120px; text-align: right; font-weight:bold; color:#000; background-color:#F2F4F4; height: 24px; border: 1px solid #b8c6d8; border-radius: 3px;" readonly tabindex="-1" value='<s:property value="orderValuefinal"/>'/>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <div class="input-search-container" style="width: 150px;">
                <input type="text" id="txtlocation" name="txtlocation" placeholder="Double click to search" value='<s:property value="txtlocation"/>' onkeydown="getloc(event);" ondblclick="getloc(event);" style="cursor: pointer;"/>
                <svg class="magnifier-icon" onclick="getloc(event);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                <input type="hidden" id="txtlocationid" name="txtlocationid" value='<s:property value="txtlocationid"/>'/>
            </div>
            
            <label class="lbl-right" id="billname" style="width:60px;">Bill Type</label>
            <select id="cmbbilltype" name="cmbbilltype" onchange="gettaxaccounts()" style="width:80px;" value='<s:property value="cmbbilltype"/>'>
            ...
            <label class="lbl-right" style="width:60px; margin-left:auto;">Ref No</label>
            <input type="text" name="refno" id="refno" style="width:100px;" value='<s:property value="refno"/>'>
            
            <label class="lbl-right" style="width:60px;">Doc No</label>
            <input type="text" name="docno" id="docno" tabindex="-1" style="width:100px;" value='<s:property value="docno"/>' readonly>
        </div>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Vendor</label>
            <div class="input-search-container" style="width: 120px;">
                <input type="text" name="puraccid" id="puraccid" placeholder="Double click to search" value='<s:property value="puraccid"/>' onKeyDown="getaccountdetails(event);" ondblclick="getaccountdetails(event);" style="cursor: pointer;" >
                <svg class="magnifier-icon" onclick="getaccountdetails(event);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            <input type="text" id="puraccname" name="puraccname" style="width: 250px;" value='<s:property value="puraccname"/>'>
            
            <label class="lbl-right" style="width:80px; margin-left:auto;">Ref Type</label>
            <select name="reftype" id="reftype" style="width:80px;" value='<s:property value="reftype"/>' onchange="funrefdisslno();">
            ...
            <div class="input-search-container" style="width: 150px; margin-left: 10px;">
                <input type="text" name="rrefno" id="rrefno" placeholder="Double click to search" value='<s:property value="rrefno"/>' onfocus="funcheckaccinvendor();" onKeyDown="getrefno(event);" ondblclick="getrefno(event);" style="cursor: pointer;">
        ...
        <div class="field-row">
            ...
            <input type="text" name="invno" id="invno" style="width:120px;" onblur="removemsg()" value='<s:property value="invno"/>'>
        </div>

        <div id="hcostcodes" hidden="true"> 
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px;">
                    <input type="text" id="itemdocno" name="itemdocno" placeholder="Double click to search" onkeydown="getitem(event);" ondblclick="getitem(event);" value='<s:property value="itemdocno"/>' style="cursor: pointer;">
                ...
                <input type="text" id="itemname" name="itemname" style="width:250px; margin-left:10px;" value='<s:property value="itemname"/>' >
            </div>
        </div>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Delivery Date</label>
            <div style="width: 120px;">
            ...
            <label class="lbl-right" style="width:80px;">Delivery Terms</label>
        ...
        <div class="field-row">
            ...
            <div style="display: flex; align-items: center; gap: 5px; margin-left: 15px;">
                <label class="lbl-right" id="lblchk">Cash Purchase</label>
                <input type="checkbox" value="0" id="chkcshprchse" name="chkcshprchse" onclick="$(this).attr('value', this.checked ? 1 : 0)">
            </div>
        </div>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" style="margin-left: 10px;" onclick="funwarningopen();">Value Change</button>
        </div>
    </div>
    ...
    <div id="psearch" class="middle-panel">
        ...
        <div class="field-row" style="align-items: flex-end; margin-bottom: 0; gap: 10px;">
            ...
            <div style="width: 60px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">FOC</label>
                <input type="text" id="focs" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" style="text-align: right; width: 100%;" />
            </div>
            <div style="width: 70px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Extra FOC</label>
                <input type="text" id="extrafocs" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" style="text-align: right; width: 100%;" />
            </div>
            <div style="width: 80px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Unit Price</label>
                <input type="text" id="uprice" onkeypress="javascript:return isNumber1(event);" onchange="calculatedata(this.id);" style="text-align: right; width: 100%;" />
            </div>
        </div>
        ...
        <div class="field-row" style="align-items: flex-end; margin-bottom: 0; gap: 10px;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="dispers" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" onchange="calculatedata(this.id);" style="text-align: right; width: 100%;" />
            </div>
            <div style="flex: 1;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Discount</label>
                <input type="text" id="dict" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" onchange="calculatedata(this.id);" style="text-align: right; width: 100%;" />
            </div>
            <div style="flex: 1;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Net Amount</label>
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="taxpers" tabindex="-1" onchange="calculatedata(this.id);" style="text-align: right; width: 100%;" />
            </div>
            <div style="flex: 1;">
            ...
            <div style="width: 70px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Multi_Batch</label>
                <input type="checkbox" id="multi" onchange="chkmultis()" style="margin-left: 5px;">
            </div>
            <div style="width: 100px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Batch</label>
                <input type="text" id="batch" onkeydown="getbatch(event)" style="width: 100%;" />
            </div>
            <div style="width: 110px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Exp Date</label>
                <div id="expdate" name="expdate" value='<s:property value="expdate"/>' style="width: 100%;"></div>
            </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0; justify-content: space-between;">
            <div style="display: flex; align-items: center; gap: 8px;">
                <label class="lbl-right">Product</label>
                <input type="text" name="productTotal" readonly="readonly" id="productTotal" value='<s:property value="productTotal"/>' style="width:100px; text-align:right;">
            </div>
            <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <button type="button" class="myButton" id="btnCalculate" title="Calculate" onclick="funcalcu();" style="padding: 0 5px;">
               <img alt="Calculate" src="<%=contextPath%>/icons/calculate_new.png" style="height: 14px; vertical-align: middle;">
            </button> 
            <div style="display: flex; align-items: center; gap: 8px;">
                <label class="lbl-right">Discount Value</label>
            ...
            <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <input type="text" name="roundOf" id="roundOf" value='<s:property value="roundOf"/>' onblur="roundval();funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" style="width:80px; text-align:right;">
            </div>
            <div style="display: flex; align-items: center; gap: 8px;">
                <label class="lbl-right">Net Total</label>
                <input type="text" name="netTotaldown" readonly="readonly" id="netTotaldown" value='<s:property value="netTotaldown"/>' onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber(event);" style="width:120px; text-align:right;">
            </div>
        </div>
    ...
    <div class="middle-panel" style="padding-bottom: 20px;">
        ...
        <div id="expDiv" class="grid-container">
            <jsp:include page="purchaseexpGrid.jsp"></jsp:include>
        </div>
    </div>

    <div class="field-row" style="justify-content: flex-end; margin-bottom: 15px;">
        <label class="lbl-right" style="width:80px;">Order Value :</label> 
        <input type="text" id="orderValue" name="orderValue" style="width:150px; text-align:right;" value='<s:property value="orderValue"/>' readonly tabindex="-1" />
    </div>
    ...
    <div id="taxsss" class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="st" name="st" style="width:120px;" value='<s:property value="st"/>' >
            
            <button type="button" class="myButton" id="process1" title="Process1" onclick="funcalutax();" style="margin-left: 5px; padding: 0 5px;">
                <img alt="process" src="<%=contextPath%>/icons/process2.png" style="height: 14px; vertical-align: middle;">
            </button>
            
            <label class="lbl-right" id="labeltax1" style="width:60px; margin-left: 10px;"></label>
            <input type="text" id="taxontax1" name="taxontax1" style="width:80px;" value='<s:property value="taxontax1"/>' >
            
            <label class="lbl-right" id="labeltax2" style="width:60px; margin-left: 10px;"></label>
            <input type="text" id="taxontax2" name="taxontax2" style="width:80px;" value='<s:property value="taxontax2"/>' >
            
            <label class="lbl-right" id="labeltax3" style="width:60px; margin-left: 10px;"></label>
            <input type="text" id="taxontax3" name="taxontax3" style="width:80px;" value='<s:property value="taxontax3"/>' >
            
            <label class="lbl-right" style="width:100px; margin-left:auto;">Net Tax Total</label>
            <input type="text" id="taxtotal" name="taxtotal" style="width:120px;" value='<s:property value="taxtotal"/>' >
        </div>
    </div>
