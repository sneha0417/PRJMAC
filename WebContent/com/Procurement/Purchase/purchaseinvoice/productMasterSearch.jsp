    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="txtdepartment" id="txtdepartment" value='<s:property value="txtdepartment"/>'>
                </td>
                <td></td>
                <td></td>
            </tr>
