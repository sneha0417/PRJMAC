	       ...
	       $.messager.confirm('Message', 'Do you want to Import?', function(r){
		        	...
		        	if(r==false)
	        		 ...
	        		 var dates=document.getElementById("masterdate").value; 
		       		  ...
		       		  $("#sevdesc").load("serviecgrid.jsp?reqdoc="+document.getElementById("reqmasterdocno").value+"&chk="+chk+"&from="+from+"&search="+search+"&dates="+dates+"&cmbbilltype="+cmbbilltype+"&accdocno="+accdocno);	
