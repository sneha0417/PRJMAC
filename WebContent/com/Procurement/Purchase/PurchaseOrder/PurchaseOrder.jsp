  	 ...
  	 if(mod1=="A")  
		{
  		...
  		document.getElementById("itemname").value=prjnames;
  		 ...
  		 $("#sevdesc").load("serviecgrid.jsp?tempdocno="+tempdocno+"&dates="+document.getElementById("nipurchaseorderdate").value); 
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" name="refno" id="refno" style="width:120px;" value='<s:property value="refno"/>'>
            
            <label class="lbl-right" style="width:80px;">Bill Type</label>
            <select id="cmbbilltype" name="cmbbilltype" onchange="gettaxaccounts()" style="width:120px;" value='<s:property value="cmbbilltype"/>'>
            ...
            <input type="text" name="docno" id="docno" tabindex="-1" style="width:120px;" value='<s:property value="docno"/>' readonly>
        </div>
        ...
        <div class="field-row">
            ...
            <select name="reftype" id="reftype" style="width:120px;" value='<s:property value="reftype"/>' onchange="funrefdisslno()">
            ...
            <div class="input-search-container" style="width: 150px; margin-left: 10px;">
                <input type="text" name="rrefno" id="rrefno" placeholder="Double click to search" value='<s:property value="rrefno"/>' onKeyDown="getrefno(event);" ondblclick="getrefno(event);" style="cursor: pointer;">
    ...
    <div id="psearch" class="middle-panel" style="background:#FFFFFF;">
        ...
        <div class="field-row" style="align-items: flex-end; gap: 10px;">
            ...
            <div style="flex: 1; min-width: 120px;">
                <label class="lbl-right" style="text-align:left; display:block; margin-bottom:4px; padding:0;">Description</label>
                <input type="text" id="prddesc" style="width: 100%;" />
            </div>
            ...
            <div style="width: 80px;">
                ...
                <input type="text" id="uprice" onblur="funRoundAmt(this.value,this.id);" onkeypress="javascript:return isNumber1(event);" onchange="calculatedata(this.id);" style="text-align: right; width: 100%;" />
            </div>
        </div>
        ...
        <div class="field-row" style="align-items: flex-end; margin-bottom:0; gap: 10px;">
            ...
            <div style="margin-bottom: 2px;">
                ...
                <input type="button" id="det" class="myButton" onclick="detailsstock()" value="Detail Stock Enquiry" style="margin-left: 5px;" />
            </div>
        </div>
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            <span class="middle-panel-title">Shipping Info</span>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Name</label>
                <div class="input-search-container" style="flex:1;">
                    <input type="text" id="shipto" name="shipto" placeholder="Double click to search" value='<s:property value="shipto"/>' onkeydown="getshipdetails(event);" ondblclick="getshipdetails(event);" style="cursor: pointer;" >
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Shipping Address</label>
            ...
            <div class="field-row">
                ...
                <label class="lbl-right" style="width:40px; margin-left:auto;">MOB</label>
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <label class="lbl-right" style="width:40px; margin-left:auto;">FAX</label>
                <input type="text" id="shipfax" name="shipfax" style="width:120px;" value='<s:property value="shipfax"/>' >
            </div>
        </div>

        <div style="flex: 1; display: flex; flex-direction: column; gap: 15px;">
            <div class="middle-panel" style="flex: 1; margin: 0; padding-bottom: 10px;">
                <span class="middle-panel-title">Shipping Details</span>
                <div id="shipdetdiv" class="grid-container" style="height: 100%;">
    ...
    <div class="middle-panel" style="display: none; padding-bottom: 20px;">
        <span class="middle-panel-title">Terms and Conditions</span>
        <div id="termsDiv" class="grid-container">
