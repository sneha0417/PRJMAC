		...
		// importsearchcontent('importoption.jsp');	
	       $.messager.confirm('Message', 'Do you want to Import?', function(r){
     	 		...
     	 		var cmbbilltype=document.getElementById("cmbbilltype").value;
		       		  ...
		       		  $("#sevdesc").load("serviecgrid.jsp?reqdoc="+ document.getElementById("reqmasterdocno").value+"&chk="+chk+"&from="+from+"&cmbreftype="+cmbreftype+"&acno="+acno+"&dates="+dates+"&cmbbilltype="+cmbbilltype);	
