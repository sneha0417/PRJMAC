   ...
   var rendererstring=function (aggregates){
    ...
    var source =
    {
        ...
        datafields: [   
						...
						{name : 'cordoc', type: 'string'},
						{name : 'corserial', type: 'string'},
	...
	/*              	   
        ...
        columns: [   
					 ...
					 { text: 'Cutting Order No', datafield: 'cordoc', width: '5%'},
					...
					/*  { text: 'SQM', datafield: 'sqm', width: '6%',aggregates: ['sum'],aggregatesrenderer:rendererstring1  }, */
					 ...
					 { text: 'Tot Size', datafield: 'totsize', width: '6%', cellsformat:'d4', cellsalign:'right', align:'right',editable:false,aggregates: ['sum'],aggregatesrenderer:rendererstring  },
					 { text: 'Price', datafield: 'price', width: '7%', cellsformat:'d4', cellsalign:'right', align:'right' ,aggregates: ['sum'],aggregatesrenderer:rendererstring,hidden:true },
    ...
    $("#cuttingOrderGridID").on('cellvaluechanged', function (event) {
        ...
        $('#sidesearchwndow').jqxWindow('close');
    	  ...
    	  if(datafield=="width" || datafield=="height" ||  datafield=="quantity" ||  datafield=="price" ||  datafield=="bevrate" ||  datafield=="polrate"||  datafield=="sqm")
    		  ...
    		  var summaryData= $("#cuttingOrderGridID").jqxGrid('getcolumnaggregateddata', 'totsize', ['sum'],true);
              
  		    
          	
  		    
              document.getElementById("totsqm").value=summaryData.sum.replace(/,/g,'');
              var summaryData2= $("#cuttingOrderGridID").jqxGrid('getcolumnaggregateddata', 'quantity', ['sum'],true);
              
  		    
          	
  		    
              document.getElementById("totqty").value=summaryData2.sum.replace(/,/g,'');
    		  }
