	 ...
	 function save(list,myarray){   
		 ...
		 var  del=$('#del').val();
	      ...
	      if(parseInt(itemval)==1)
		      ...
		      x.open("POST", <%=contextPath+"/"%>+"com/common/termsavedatanew.jsp?docno="+document.getElementById("docno").value+"&dtype="+document.getElementById("formdetailcode").value+"&brhid="+$('#brchName').val()+"&list="+encodeURIComponent(list)+"&chk="+del+"&myarray="+encodeURIComponent(myarray));
