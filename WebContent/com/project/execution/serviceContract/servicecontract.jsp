...
$(document).ready(function() {
    /* Initialize Modern JqxDateTimes */
    $("#date, #stdate, #enddate, #finsdate, #serdate").jqxDateTimeInput({ 
        width: '120px', 
        height: 24, 
    ...
    $('#clientsearch1').jqxWindow({ width: '50%', height: '55%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Client Search' , position: { x: 250, y: 120 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#clientsearch1').jqxWindow('close');
    $('#cpinfowindow').jqxWindow({ width: '35%', height: '62%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Contact Person Search' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#cpinfowindow').jqxWindow('close');
    $('#areainfowindow').jqxWindow({ width: '25%', height: '70%',  maxHeight: '85%' ,maxWidth: '80%' ,title: ' Area Search' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#areainfowindow').jqxWindow('close');
    $('#siteinfowindow').jqxWindow({ width: '25%', height: '70%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Site Search' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#siteinfowindow').jqxWindow('close');
    $('#grpinfowindow').jqxWindow({ width: '25%', height: '70%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Assign Group' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#grpinfowindow').jqxWindow('close');
    $('#teaminfowindow').jqxWindow({ width: '30%', height: '70%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Assign Team' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#teaminfowindow').jqxWindow('close');
    $('#sertypefowindow').jqxWindow({ width: '30%', height: '65%',  maxHeight: '85%' ,maxWidth: '80%' ,title: 'Service Type' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#sertypefowindow').jqxWindow('close');
    $('#schserchinfowindow').jqxWindow({ width: '80%', height: '60%',  maxHeight: '90%' ,maxWidth: '90%' ,title: 'Schedule Search' , position: { x: 150, y: 50 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#schserchinfowindow').jqxWindow('close');
    $('#serviceteamwindow').jqxWindow({ width: '25%', height: '70%',  maxHeight: '85%' ,maxWidth: '80%' ,title: ' Service Team Search' , position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme:'energyblue'});
    $('#serviceteamwindow').jqxWindow('close');
            
    refChange();getsjobtype();
    
    $('#txtclient').dblclick(function(){ openClientSearch(); });
    $('#srvsite').dblclick(function(){ openSiteSearch(); });
    $('#srvser').dblclick(function(){ openServiceTypeSearch(); });
    $('#rrefno').dblclick(function(){ openEnqSearch(); });
    $('#txtcontact').dblclick(function(){ openContactSearch(); });
...
function openServiceTypeSearch() {
    if($('#mode').val() != "view") {
...
<form id="frmservicecontract" action="saveServicecontract" method="post" autocomplete="off">
    ...
    <div class='hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <label class="lbl-right" style="width:100px; margin-left: 15px;">Ref No</label>
                ...
                <input type="text" name="docno" id="docno" style="width:150px;" value='<s:property value="docno" />' tabindex="-1" readonly>
            </div>
        </div>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width:150px;">
                    ...
                    <svg class="magnifier-icon" onclick="openClientSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <input type="text" name="txtsalman" id="txtsalman" style="flex:1;" value='<s:property value="txtsalman" />'>
            </div>
            
            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:100px;">Mail</label>
                <input type="text" name="txtemail" id="txtemail" style="width:150px;" value='<s:property value="txtemail" />'>
                ...
                <div class="input-search-container" style="width:150px;">
                    ...
                    <svg class="magnifier-icon" onclick="openContactSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            </div>
        </div>

        <div class="middle-panel">
            <span class="middle-panel-title">Contract Configuration</span>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Type</label>
                <select name="cmbprocess" id="cmbprocess" style="width:150px;" onchange="funcomprehensivetext();" value='<s:property value="cmbprocess"/>'></select>
                <input type="hidden" name="hidcmbprocess" id="hidcmbprocess" value='<s:property value="hidcmbprocess"/>' />
                
                <label class="lbl-right" id="lblThresholdLimit" style="display:none; width:100px;">Threshold Limit</label>
                <input type="text" id="txtthresholdlimit" name="txtthresholdlimit" style="width:100px; text-align:right; display:none;" onkeypress="javascript:return isNumber (event,id)" value='<s:property value="txtthresholdlimit"/>'/>
                
                <label class="lbl-right" id="lblPartLimitPerc" style="display:none; width:80px;">Part Limit %</label>
                <input type="text" id="txtpartlimitperc" name="txtpartlimitperc" style="width:80px; text-align:right; display:none;" onkeypress="javascript:return isNumber (event,id)" onblur="funmaxlength(this.value,this.id);" value='<s:property value="txtpartlimitperc"/>'/>
                
                <label class="lbl-right" style="width:100px; margin-left:auto;">Contract Value</label>
                ...
                <label style="display:flex; align-items:center; gap:5px; margin-left:10px; cursor:pointer;" for="chkincltax">
                    <input type="checkbox" name="chkincltax" id="chkincltax" value='<s:property value="chkincltax" />' onclick="$(this).attr('value', this.checked ? 1 : 0);">
                    <span style="font-size:12px; font-weight:bold; color:#444;">Incl tax</span>
                </label>
            </div>
            
            <div class="field-row">
                <label style="width:100px; text-align:right; font-weight:bold; color:#444; display:flex; align-items:center; justify-content:flex-end; gap:5px; cursor:pointer;" for="chklegaldoc">
                    <input type="checkbox" name="chklegaldoc" id="chklegaldoc" onchange="legChange();">
                    <span>Legal Fee</span>
                </label>
                <input type="text" id="temp1" name="temp1" style="width:70px;" value='<s:property value="temp1"/>'/>
                <input type="text" id="temp2" name="temp2" style="width:70px;" value='<s:property value="temp2"/>' />
                
                <label class="lbl-right" style="width:70px;">Incentive</label>
                <input type="text" name="incentive" id="incentive" style="width:100px; text-align:right;" value='<s:property value="incentive"/>'>
                
                <label class="lbl-right" style="width:100px;">Sales Incentive</label>
                <input type="text" name="salesincentive" id="salesincentive" style="width:100px; text-align:right;" value='<s:property value="salesincentive"/>'>
                
                <label class="lbl-right" style="width:60px;">Budget</label>
                <input type="text" id="txtbudget" name="txtbudget" style="width:100px; text-align: right;" value='<s:property value="txtbudget"/>'/>
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <select id="cmbreftype" name="cmbreftype" style="width:80px;" onchange="refChange();" value='<s:property value="cmbreftype"/>'>
                ...
                <div class="input-search-container" style="width:150px;">
                    ...
                    <svg class="magnifier-icon" onclick="openEnqSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
                
                <label class="lbl-right" style="width:70px;">St.Date</label>
                <div style="width: 120px;">
                    <div id="stdate" name="stdate" value='<s:property value="stdate" />'></div>
                </div>
                
                <label class="lbl-right" style="width:70px;">End Date</label>
                <div style="width: 120px;">
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="text" name="installments" id="installments" style="width:80px; text-align:right;" value='<s:property value="installments"/>'>
                
                <label class="lbl-right" style="margin-left: 15px;">Due After</label>
                <input type="text" name="paydueafter" id="paydueafter" style="width:80px; text-align:right;" value='<s:property value="paydueafter"/>'>
                
                <label class="lbl-right" style="margin-left: 15px;">Frequency</label>
                ...
                <label class="lbl-right" style="margin-left: 15px;">First Inst.On</label>
                <div style="width: 120px;">
            ...
            <div id="prog" class="field-row" style="display:none;">
                ...
                <label class="lbl-right" style="margin-left: 15px;">Period (months)</label>
                <input type="text" id="txtprogperiod" name="txtprogperiod" style="width:80px; text-align:right;" value='<s:property value="txtprogperiod"/>'/>
                
                <label class="lbl-right" style="margin-left: 15px;">Percentage</label>
                <input type="text" id="txtprogper" name="txtprogper" style="width:80px; text-align:right;" value='<s:property value="txtprogper"/>'/>
            </div>
            
            <div id="paydiv" class="grid-container" style="margin-top:10px;">
        ...
        <div class="middle-panel">
            ...
            <div id="schserdiv" class="field-row">
                <label style="display:flex; align-items:center; gap:5px; cursor:pointer;" for="chkserv">
                    <input type="checkbox" name="chkserv" id="chkserv" value='<s:property value="chkserv" />' onclick="$(this).attr('value', this.checked ? 1 : 0);funsercheck();">
                    <span style="font-size:12px; font-weight:bold; color:#444;">Service</span>
                </label>
                
                <label id="chklblinv" style="display:flex; align-items:center; gap:5px; margin-left:15px; cursor:pointer;" for="chkinv">
                    <input type="checkbox" name="chkinv" id="chkinv" value='<s:property value="chkinv" />' onclick="$(this).attr('value', this.checked ? 1 : 0);">
                    <span style="font-size:12px; font-weight:bold; color:#444;">To Be Invoiced</span>
                </label>
                
                <button class="myButton" type="button" id="btnsearch" name="btnsearch" onclick="schSearch();" style="margin-left: 15px;">Search</button>
                
                <label class="lbl-right" style="margin-left:auto;">Interval</label>
                <input type="text" name="srvcinterval" id="srvcinterval" style="width:80px; text-align:right;" value='<s:property value="srvcinterval"/>'>
                
                <label class="lbl-right" style="margin-left: 15px;">Due After</label>
                <input type="text" name="serdueafter" id="serdueafter" style="width:80px; text-align:right;" value='<s:property value="serdueafter"/>'>
                ...
                <label class="lbl-right" style="margin-left: 15px; width:100px;">Service Start On</label>
                <div style="width: 120px;">
            ...
            <div id="schediv" class="grid-container" style="margin-top:10px;">
    ...
    <div id="errormsg" style="color:red; font-weight:bold; margin-left: 15px;"></div>
