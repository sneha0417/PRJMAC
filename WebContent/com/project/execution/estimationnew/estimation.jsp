...
var mastertrno='<%=mastertrno%>';
      $(document).ready(function () {
         ...
         $('#sidesearchwndow').jqxWindow({ width: '70%', height: '80%',  maxHeight: '90%' ,maxWidth: '80%' ,title: 'Search ' , position: { x: 543, y: 0 }, keyboardCloseKey: 27});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <label class="lbl-right" style="width:80px;">Revise No.</label>
            <input type="text" id="txtreviseno" name="txtreviseno" style="width:120px;" value='<s:property value="txtreviseno"/>'/>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Customer & Reference Info</span>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Customer</label>
            <input type="text" id="txtclient" name="txtclient" style="width:120px;" placeholder="Press F3" value='<s:property value="txtclient"/>' onKeyDown="getclinfo(event);"/>
            ...
            <input type="text" id="txtenquiry" name="txtenquiry" style="width:120px;" placeholder="Press F3" value='<s:property value="txtenquiry"/>' onKeyDown="getEnquiry(event);"/>
            <input type="hidden" id="txtcontrmode" name="txtcontrmode" value='<s:property value="txtcontrmode"/>'/>
            
            <label id="lblscopegroup" class="lbl-right" style="width:80px;">Scope Group</label>
            <select id="cmbscopegroup" name="cmbscopegroup" style="width:120px;" onchange="getScopeAMCDetails();" value='<s:property value="cmbscopegroup"/>'>
                <option value="">--Select--</option>
            </select>
            <input type="hidden" id="hidcmbscopegroup" name="hidcmbscopegroup" value='<s:property value="hidcmbscopegroup"/>'/>
        </div>
        
        <div class="field-row" id="tblpresalesscope">
            <label class="lbl-right" style="width:80px;">Site</label>
            <input type="text" id="txtsite" name="txtsite" style="width:120px;" value='<s:property value="txtsite"/>' onKeyDown="getsites(event);"/>
            <input type="hidden" id="txtsiteid" name="txtsiteid" value='<s:property value="txtsiteid"/>'/>
            
            <label class="lbl-right" style="width:80px;">Template</label>
            <input type="text" id="txttemplatecode" name="txttemplatecode" style="width:120px;" placeholder="Press F3" value='<s:property value="txttemplatecode"/>' onKeyDown="getTemplate(event);"/>
            <input type="hidden" id="txttemplateid" name="txttemplateid" value='<s:property value="txttemplateid"/>'/>
            
            <input type="text" id="txttemplatename" name="txttemplatename" style="flex:1;" tabindex="-1" value='<s:property value="txttemplatename"/>' readonly/>
            
            <button class="myButton" type="button" id="btntemplateadd" name="btntemplateadd" onclick="funTemplateLoadAdd();">ADD</button>
        </div>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtnettotalshow" name="txtnettotalshow" style="width:120px; text-align:right; font-weight:bold; background-color:#F2F4F4; color:#000;" readonly tabindex="-1" value='<s:property value="txtnettotal"/>'/>
        </div>
    </div>
...
<div id="activitysearchwindow"><div></div></div>
<div id="clientsearch1"><div></div></div>
<div id="sidesearchwndow"><div></div></div>
<div id="lchargeinfowindow"><div></div></div>
<div id="echargeinfowindow"><div></div></div>
<div id="enquirywindow"><div></div></div>
<div id="servicetypewindow"><div></div></div>
<div id="sitewindow"><div></div></div>
<div id="unitsearchwindow"><div></div></div>
<div id="templatesearchwindow"><div></div></div>
