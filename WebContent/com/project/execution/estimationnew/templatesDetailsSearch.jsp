...
========================================================= */
div#search.modern-ui input#btnTemplateSearch.myButton {
    height: 24px !important; 
...
/* The Hover State */
div#search.modern-ui input#btnTemplateSearch.myButton:hover {
...
function getTemplateDetails(code, name, check) {
    ...
    $("#refreshTemplateDetailsDiv").load("templatesDetailsSearchGrid.jsp?code=" + encodeURIComponent(code) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="lbl-right">Code</td>
                <td><input type="text" name="txttempcode" id="txttempcode" value='<s:property value="txttempcode"/>'></td>
                
                <td class="lbl-right">Name</td>
                <td><input type="text" name="txttempcodename" id="txttempcodename" value='<s:property value="txttempcodename"/>'></td>
                
                <td align="center" valign="middle" style="padding-left: 15px;">
                    <input type="button" name="btnTemplateSearch" id="btnTemplateSearch" class="myButton" value="Search" onclick="loadTemplateSearch(); return false;">
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="grid-container">
        <div id="refreshTemplateDetailsDiv">
            <jsp:include page="templatesDetailsSearchGrid.jsp"></jsp:include>
        </div>
    </div>
