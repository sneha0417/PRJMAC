        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text"
                           name="pjivmsdocno"
                           id="pjivmsdocno"
                           value='<s:property value="pjivmsdocno"/>'>
                </td>
                ...
                <td>
                    <input type="text"
                           name="pjivCl_names"
                           id="pjivCl_names"
                           value='<s:property value="pjivCl_names"/>'>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div id="pjivinvdate"
                         name="pjivinvdate"
                         value='<s:property value="pjivinvdate"/>'>
                    </div>
                </td>
                ...
                <td>
                    <input type="text"
                           name="pjivcontno"
                           id="pjivcontno"
                           value='<s:property value="pjivcontno"/>'>
                </td>
