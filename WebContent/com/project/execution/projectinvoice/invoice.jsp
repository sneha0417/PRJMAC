...
$(document).ready(function() {
      // Adjusted initialization for modern UI size
			...
			if (($("#mode").val() == "view") && $("#docno").val()!="") {
				...
				var docno=$('#docno').val();
		 		...
		 		var reurl=url.split("com/"); 
		 		 ...
		 		 if (parseInt($("#txtprintwindowallowed").val())==2) {
				...
				if (parseInt(chk)>0) {
				 	...
				 	var win= window.open(reurl[0]+"printInvoice?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&bankdocno=0&header=1&freq=1","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
			     	win.focus();
				} 
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <select name="cmbcontracttype" id="cmbcontracttype" style="width:125px;" value='<s:property value="cmbcontracttype"/>' onchange="refChange();">
                    ...
                    <label class="lbl-right" id="contrno" style="width:100px;">Contract No</label>
                    <input type="text" name="txtrefdetails" id="txtrefdetails" style="width:150px;" placeholder="Press F3" onKeyDown="getcontract(event);" value='<s:property value="txtrefdetails"/>'>
                    ...
                    <input type="text" name="txtclient" id="txtclient" style="width:100px;" placeholder="Press F3" onKeyDown="getclinfo(event);" value='<s:property value="txtclient"/>'>
                    <input type="text" name="txtclientdet" id="txtclientdet" style="flex:1; margin-left: 8px;" tabindex="-1" readonly value='<s:property value="txtclientdet"/>'>
                </div>
