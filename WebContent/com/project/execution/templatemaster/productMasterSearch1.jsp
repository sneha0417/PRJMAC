...
<%
String scopeid=request.getParameter("scopeid")==null?"0":request.getParameter("scopeid").trim();
String srvtypeid=request.getParameter("srvtypeid")==null?"0":request.getParameter("srvtypeid").trim();
%>
	<script type="text/javascript">
	var scopeid='<%=scopeid%>';
	var srvtypeid='<%=srvtypeid%>';
	alert(scopeid);
	alert(srvtypeid);
