...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
	    ...
	    getdata1(Cl_namess,msdocno,dates);
			}
 	
	  function getdata1(Cl_namess,msdocno,dates){
		  
		  var id=1;
		
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_namess='+Cl_namess+'&msdocno='+msdocno+'&dates='+dates+'&id='+id);
