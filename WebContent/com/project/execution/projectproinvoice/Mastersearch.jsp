...
$(document).ready(function () {
    // Initializing the jqxDateTimeInput widget without inline styling overrides
    $("#invdate").jqxDateTimeInput({ 
        width: '100%', 
        height: '24px', // Matched to .modern-ui standard height
...
function invloadSearch1() {
    // Safely pull value from jqx widget or standard DOM element
    var invdate = $('#invdate').val() || (document.getElementById("invdate") ? document.getElementById("invdate").value : "");
...
function getdata1(Cl_names, msdocno, contno, invdate, invtype) {
    ...
    $("#refreshdivmas").load('subMastersearch.jsp?Cl_names=' + encodeURIComponent(Cl_names) + 
                             ...
                             '&invdate=' + encodeURIComponent(invdate) + 
