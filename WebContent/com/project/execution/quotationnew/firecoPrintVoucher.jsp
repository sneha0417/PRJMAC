...
<table width="100%">
  <tr>
    ...
    <tr>
  	...
  	<td id=td1 align="right" width="50%"><input type="radio" id="rdbncmprhnshow" name="rdbncmprhnshow" onchange="funcmprhncheck();" value="Show Comprehensive" checked="checked">With Comprehensive</td>
    
    <td  id=td2 align="left" width="50%"><input type="radio" id="rdbncmprhnhide" name="rdbncmprhnshow" onchange="funcmprhncheck();" value="Hide Comprehensive">Without Comprehensive
    </td> 
     <td><input type="hidden" id="cmprhnstat" name="cmprhnstat" value="1" /></td>
    ...
    <td  align="left" width="50%"><input type="radio" id="rdbnxlhide" name="rdbnxl" onchange="funxlshowcheck();" value="Hide xl" ><label id="lblwithxl">With Excel</label>
    							  <input type="hidden" id="xlstat" name="xlstat" value="1" /></td>
