...
// Pulling rownindex securely from the JSP scriptlet
...
function getdata(employeeName, empId, contactNo) {
    ...
    $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename=' + encodeURIComponent(employeeName) + 
                          ...
                          '&rownindex=' + encodeURIComponent(rownindex));
}
</script>
</head>
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <!-- Fixed 24px height button, vertically centered between the rows -->
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- Hidden field managed securely here -->
