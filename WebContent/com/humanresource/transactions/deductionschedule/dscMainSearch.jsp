...
<title>GatewayERP(i)</title>
	...
	function getdata(empname,docNo,date,amount, employeebranchchk, branch){
		 $("#refreshdiv").load('dscMainSearchGrid.jsp?empname='+empname.replace(/ /g, "%20")+'&docNo='+docNo+'&date='+date+'&amount='+amount+'&branch='+branch+'&employeebranchchk='+employeebranchchk);
		}
