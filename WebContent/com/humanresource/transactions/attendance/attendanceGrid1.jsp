        ...
        $(document).ready(function () { 	
            ...
            $("#attendanceGridID").on("bindingcomplete", function (event) {
					 ...
					 for(var k=0 ; k < leavetype ; k++){
						 ...
						 //alert($('#cmbleavetype option').eq(k).text().trim());
						// alert($('#cmbleavetype option').eq(k).text().trim()=='Casual Leave');
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Unpaid Leave', datafield: 'leave1total', width: '7%', cellsalign: 'center', align: 'center', cellbeginedit: function (row) {
							...
							{ text: 'Paid Leave', datafield: 'leave4total', width: '8%', cellsalign: 'center', align: 'center', cellbeginedit: function (row) {
                ...
                for(var i=1;i<=parseInt(totdays);i++)
         		{
                	...
                	if(value=='U'){leave1total=leave1total+1;} 
                	...
                	if(value=='U2'){leave1total=leave1total+(0.5);} 
