    ...
    <div class="modern-ui">
        <div class="middle-panel" style="margin-top: 5px;">
            ...
            <div class="field-row">
                ...
                <label class="lbl-right" style="width:60px;">Leave</label>
                <input type="text" name="leave" id="leave" style="flex:1; min-width: 120px;" placeholder="Leave" value='<s:property value="leave"/>'>
                
                <label class="lbl-right" style="width:90px;">Abbreviation</label>
                <div class="input-search-container" style="width: 160px;">
                    <input type="text" name="abbreviation" id="abbreviation" placeholder="Press F3 to Search" onkeydown="getAbbrevation(event);" readonly="readonly" value='<s:property value="abbreviation"/>' style="width: 100%;">
                    <svg class="magnifier-icon" onclick="getAbbrevation(event);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
