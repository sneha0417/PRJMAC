    ...
    <div class="modern-ui">
        <div class="middle-panel" style="margin-top: 5px;">
            ...
            <div class="field-row">
                ...
                <label class="lbl-right" style="width:130px;">Statutory Deductions</label>
                <input type="text" name="satudeduction" id="satudeduction" style="flex:1; min-width: 150px;" placeholder="Statutory Deductions" value='<s:property value="satudeduction"/>'>
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 160px;">
                    <input type="text" name="acno" id="acno" readonly="readonly" placeholder="Press F3 To Search" onKeyDown="getaccountdetails(event);" value='<s:property value="acno"/>' style="width: 100%;">
                ...
                <input type="text" name="accname" id="accname" style="flex:1; min-width: 150px;" readonly="readonly" value='<s:property value="accname"/>'>

                <label class="lbl-right" style="width:50px;">Type</label>
                <select name="type" id="type" value='<s:property value="type"/>' style="width:120px;">
