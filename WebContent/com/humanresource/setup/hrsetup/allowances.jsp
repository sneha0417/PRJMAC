    ...
    <div class="modern-ui">
        <div class="middle-panel" style="margin-top: 5px;">
            ...
            <div class="field-row">
                ...
                <label class="lbl-right" style="width:80px;">Allowance</label>
                <input type="text" name="allowancecode" id="allowancecode" style="width:120px;" placeholder="Allowance Code" value='<s:property value="allowancecode"/>'>
                
                <label class="lbl-right" style="width:50px;">Name</label>
                <input type="text" name="allowance" id="allowance" style="flex:1; min-width: 150px;" placeholder="Allowance Name" value='<s:property value="allowance"/>'>
