...
$(document).ready(function() {
    ...
    /* Standardized 24px height widgets */
    $("#date").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });
    $("#fromdate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });
    $("#todate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy" });
    ...
    <form id="frmAssetSalesInvoice" action="saveActionAssetSalesInvoice" autocomplete="off" >
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Asset Sales Invoice</span>
                ...
                <div class="field-row">
                    ...
                    <select name="cmbtype" id="cmbtype" style="width:120px;">
                    ...
                    <input type="text" name="vocno" id="vocno" value='<s:property value="vocno"/>' style="width:120px;" tabindex="-1" readonly>
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:80px;">Client</label>
                    <div class="input-search-container" style="width: 125px;">
                        <input type="text" name="client" id="client" value='<s:property value="client"/>' placeholder="Press F3" readonly onkeydown="getClient(event);">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="button" name="btncalculate" id="btncalculate" class="myButton" style="margin-left: 15px;" onclick="funCalculate();" value="Calculate">
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Asset Records</span>
                <div id="assetInvoicediv" class="grid-container">
