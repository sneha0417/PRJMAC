...
$(document).ready(function () {
    ...
    $("#masterdate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});    
    $("#purchasedate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});  
    $("#warexpdate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});  
...
function setValues() {
    if($('#hidmasterdate').val()){ $("#masterdate").jqxDateTimeInput('val', $('#hidmasterdate').val()); }
    if($('#hidpurchasedate').val()){ $("#purchasedate").jqxDateTimeInput('val', $('#hidpurchasedate').val()); }
    if($('#hidwarexpdate').val()){ $("#warexpdate").jqxDateTimeInput('val', $('#hidwarexpdate').val()); }
...
function funsetdatas() {
    ...
    if($('#assetGroupval').val()!=""){ $("#assetGroup").val($('#assetGroupval').val()); }
    if($('#locationval').val()!=""){ $("#location").val($('#location').val()); }
}
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="docno" name="docno" value='<s:property value="docno"/>' style="width:120px;" tabindex="-1" readonly />
                </div>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="assetname" name="assetname" value='<s:property value="assetname"/>' style="flex:1;" />
                </div>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <select id="assetGroup" name="assetGroup" value='<s:property value="assetGroup"/>' style="width:250px;">
                        <option value="">--Select--</option>
                    </select>
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Location</label>
                    <select id="location" name="location" value='<s:property value="location"/>' style="width:250px;">
                        <option value="">--Select--</option>
                    </select>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                    ...
                    <div class="field-row">
                        ...
                        <input type="text" id="supplieraccName" name="supplieraccName" value='<s:property value="supplieraccName"/>' style="flex:1;" tabindex="-1" readonly />
                    </div>
                    
                    <div class="field-row">
                        <label class="lbl-right" style="width:120px;">Purchase Ref No.</label>
                        <input type="text" id="purchrefno" name="purchrefno" value='<s:property value="purchrefno"/>' style="flex:1;" />
                    ...
                    <div class="field-row">
                        ...
                        <input type="text" id="noofitems" name="noofitems" value='<s:property value="noofitems"/>' style="width:100px;" onkeypress="javascript:return isNumber(event);" />
                        
                        <label class="lbl-right" style="width:120px; margin-left:auto;">Total Purch. Value</label>
                        <input type="text" id="totalpuchvalue" name="totalpuchvalue" value='<s:property value="totalpuchvalue"/>' style="width:125px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funchkaccum();" onkeypress="javascript:return isNumber(event);" />
                    </div>
                    
                    <div class="field-row" style="margin-bottom:0;">
                        <label class="lbl-right" style="width:120px;">WNTY DocNo</label>
                        <input type="text" id="wntydocno" name="wntydocno" value='<s:property value="wntydocno"/>' style="width:100px;" />
                        
                        <label class="lbl-right" style="width:120px; margin-left:auto;">WNTY Exp Date</label>
                        <div style="width: 125px;">
                ...
                <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                    ...
                    <div class="field-row" style="margin-bottom: 15px;">
                        ...
                        <label style="font-size: 12px; font-weight: bold; color: #444; margin-left: 5px;">Enable Sub Details</label>
                    </div>
                    <div id="subdetail" class="grid-container" hidden="true">
                        <jsp:include page="subdetails.jsp"></jsp:include>
                    </div>
                    <div id="freespace" class="container"><br><br><br></div>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                    ...
                    <div class="field-row" style="margin-bottom: 15px;">
                        ...
                        <label style="font-size: 12px; font-weight: bold; color: #444; margin-left: 5px;">Opening</label>
                    </div>
                    
                    <div class="field-row">
                        <label class="lbl-right" style="width:100px;">Accum. Depr</label>
                        <input type="text" id="accumdepr" name="accumdepr" value='<s:property value="accumdepr"/>' style="width:100px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funchktotal();" onkeypress="javascript:return isNumber(event);" />
                        
                        <label class="lbl-right" style="width:100px; margin-left:auto;">Life Time (Yr)</label>
                        <input type="text" id="lifetimeyear" name="lifetimeyear" value='<s:property value="lifetimeyear"/>' style="width:80px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funcalculatedep();" onkeypress="javascript:return isNumber(event);" />
                        
                        <label class="lbl-right" style="width:60px; margin-left:auto;">Depr %</label>
                        <input type="text" id="depper" name="depper" value='<s:property value="depper"/>' style="flex:1; text-align:right;" onblur="funRoundAmt(this.value,this.id);funcalcuyear();" onkeypress="javascript:return isNumber(event);" />
                    </div>
                ...
                <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                    ...
                    <div class="field-row">
                        <label class="lbl-right" style="width:90px;">Fixed Asset</label>
                        <div class="input-search-container" style="width: 125px;">
                        ...
                        <input type="text" id="fixedassetaccName" name="fixedassetaccName" value='<s:property value="fixedassetaccName"/>' style="flex:1;" tabindex="-1" readonly />
                    </div>
                    
                    <div class="field-row">
                        <label class="lbl-right" style="width:90px;">Accu. Depr</label>
                        <div class="input-search-container" style="width: 125px;">
                        ...
                        <input type="text" id="accdepraccName" name="accdepraccName" value='<s:property value="accdepraccName"/>' style="flex:1;" tabindex="-1" readonly />
                    </div>
                    
                    <div class="field-row" style="margin-bottom:0;">
                        <label class="lbl-right" style="width:90px;">Depreciation</label>
                        <div class="input-search-container" style="width: 125px;">
                        ...
                        <input type="text" id="depraccName" name="depraccName" value='<s:property value="depraccName"/>' style="flex:1;" tabindex="-1" readonly />
                    </div>
                </div>
            </div>
