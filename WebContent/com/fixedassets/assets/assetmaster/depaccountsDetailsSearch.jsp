...
function loadAccountSearch() {
    ...
    // Safely pull the dates parameter (assuming #masterdate exists on parent wrapper)
    var dateElement = document.getElementById("masterdate");
    var dates = dateElement ? dateElement.value : ($('#masterdate').val() || "");
