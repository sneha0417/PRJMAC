...
$(document).ready(function() {
    ...
    $("#jqxFixedAssetDepreciationPostingDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
    ...
    <form id="frmFixedAssetDepreciationPosting" action="fixedassetdepreciationposting" method="post" autocomplete="off">
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Depreciation Posting Details</span>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <button type="button" class="myButton" id="btnProcessing" style="margin-left: 10px;" onclick="funProcessBtn();">Process</button>
                    <button type="button" class="myButton" id="btnCalculate" style="margin-left: 10px;" onclick="funCalculateBtn();">Calculate</button>
                    <button type="button" class="myButton" id="btnExcelExporter" style="margin-left: 10px;" onclick="funExcelExporter();">Export to Excel</button>
                    
                    <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
                    <input type="text" id="docno" name="txtjvno" value='<s:property value="txtjvno"/>' style="width:120px;" tabindex="-1" readonly />
                </div>
            </div>
